...
public class fzQueryServlet
{
  ...
  public static String returnZzjgdm(String sszzjg) {
    ...
    try {
      ...
      if (sszzjg.equals("210200000000")) {
        ...
        String sql = "select zzjgdm from pgisapp.t_zzjg where zzjgdm='" + sszzjg + "' or ssjgdm='" + sszzjg + "'";
  ...
  public static String returnSqlStr(String zzjgStr, String queryLx, String kssj, String jssj, String zzjglx) {
    ...
    if (zzjglx.equals("11"))
    {
      whereStr = " and xzqhdm ='" + zzjgStr + "'";
    }
    else whereStr = " and jjdwdm ='" + zzjgStr + "'";

    sqlStr = "select * from (select count(1) as a from jcj_jq_pt t1 where t1.bjsj > to_date('" + 
      kssj1 + "', 'YYYY-MM-DD hh24:mi-ss')" + 
      " and t1.bjsj < to_date('" + jssj1 + "', 'YYYY-MM-DD hh24:mi-ss')" + whereStr + ") table1," + 
      "(select count(1) as b from jcj_jq_pt t2 where t2.bjsj > to_date('" + kssj2 + "', 'YYYY-MM-DD hh24:mi-ss')" + 
      " and t2.bjsj < to_date('" + jssj2 + "', 'YYYY-MM-DD hh24:mi-ss')" + whereStr + ") table2," + 
      "(select count(1) as c from jcj_jq_pt t3 where t3.bjsj > to_date('" + kssj3 + "', 'YYYY-MM-DD hh24:mi-ss')" + 
      " and t3.bjsj < to_date('" + jssj3 + "', 'YYYY-MM-DD hh24:mi-ss')" + whereStr + ") table3," + 
      "(select count(1) as d from jcj_jq_pt t4 where t4.bjsj > to_date('" + kssj4 + "', 'YYYY-MM-DD hh24:mi-ss')" + 
      " and t4.bjsj < to_date('" + jssj4 + "', 'YYYY-MM-DD hh24:mi-ss')" + whereStr + ") table4," + 
      "(select count(1) as e from jcj_jq_pt t5 where t5.bjsj > to_date('" + kssj5 + "', 'YYYY-MM-DD hh24:mi-ss')" + 
      " and t5.bjsj < to_date('" + jssj5 + "', 'YYYY-MM-DD hh24:mi-ss')" + whereStr + ") table5";
