					...
					<tbody>
					     <tr class="dialogTr">
							...
							<input type="text" class="searchText" name="bjnr"  id="bjnr" 
									style="height:32px;font-size:18px;width:240px;color: gray" onclick="setBjnr(this)" onkeydown="passwordOnkeyPress(this)"/>
						</td>
						<td align="left">
...
function queryButton(){
	...
	var sfdt =0;
	var reloadUrl  = contextPath + '/jcj/queryJcjList';
...
function doEdit(linkObject, index) {
	...
	var editUrl = "/jcj?id="+rowData.id+"&sfcx=1&mainTabID="+getMainTabID();
