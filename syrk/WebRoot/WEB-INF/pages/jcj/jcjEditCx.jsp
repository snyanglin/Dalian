...
<div class="clear"></div>
<div class="editdiv"><a href="javascript:void(0);" class="savebtn">档案编辑完成</a><a href="javascript:void(0);" class="editbtn" style="display:none" id="bjdaxx">编辑档案信息</a><c:if test="${jcj.qszt == '0'}"></c:if></div>
