	    	  ...
	    	  <div data-options="region:'center', split:true" style="width:800px; border-width: 0px;">
    			...
    			<form action="" id="jbxxForm" name="jbxxForm" method="post">
	    	      ...
	    	      <tr class="dialogTr">
				    	...
				    	<td width="30%" class="dialogTd"><input class='easyui-combobox' type='text' id="jbxx_mzdm" name='jbxx.mzdm' value="${ryjbxxb.mzdm}" style="width:200px;" 
		    	                data-options="url: contextPath + '/common/dict/D_BZ_MZ.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',tipPosition:'left'"/></td> 
	    	      </tr>
	    	      <tr class="dialogTr">
				    	<td width="20%" class="dialogTd" align="right">籍贯：</td>
				    	<td width="30%" class="dialogTd"><input class='easyui-combobox' type='text' id="jbxx_jgssxdm" name='jbxx.jgssxdm' value="${ryjbxxb.jgssxdm}" style="width:200px;" 
		    	                data-options="mode:'remote',dataFilter:'.*[^00]$',valueField:'id',textField:'text',selectOnNavigation:false,method:'post'"/></td>
				    	<td width="20%" class="dialogTd" align="right">国家/地区：</td>
				    	<td width="30%" class="dialogTd"><input class='easyui-combobox' type='text' id="jbxx_jggjdqdm" name='jbxx.jggjdqdm' value="${ryjbxxb.jggjdqdm}" style="width:200px;" 
		    	                data-options="url: contextPath + '/common/dict/D_BZ_GJDQLIST.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',required:true,tipPosition:'left',
	    		  ...
	    		  <tr class="dialogTr">
			    	...
			    	<td width="50%" class="dialogTd" colspan="2">
				    	<input class="easyui-combobox" id="jbxx_hjd1" style="width:380px;" value="${ryjbxxb.dz_hjdmlpxz}" data-options="required:false,mode:'remote',method:'post',panelHeight: 22,valueField:'id',textField:'text',selectOnNavigation:false">
				    	<input type='hidden' name='jbxx.dz_hjdmlpdm' id="jbxx_dz_hjdmlpdm" value="${ryjbxxb.dz_hjdmlpdm}"/>
	    		  ...
	    		  <tr class="dialogTr">
	    	       ...
	    	       <tr class="dialogTr">
				    	<td width="20%" class="dialogTd" align="right" style="color: #FF0000;font-weight: bold;">实有人口类型：</td>
				    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-combobox" type="text" id="syrkgllbdm"  name="syrkgllbdm" value="${syrkgllbdm}" style="width:200px;"
							data-options="url: contextPath + '/common/dict/D_RK_SYRKGLLB.js',valueField:'id',textField:'text',dataFilter:'01|02|03|04|05',selectOnNavigation:false,method:'get',tipPosition:'left',required:true,onChange: divChange"/></td> 
	    	       </tr>
    			</form>
	    		</table>
		    </div>
...
$(document).ready(function(){
	...
	$("#saveBotton").bind("click",function() {
		...
		if($('#ldrk.fwcs').val()==''||$('#ldrk.fwcs').val()==null||$('#ldrk.fwcs').val()=="undefined"){
			document.getElementById("ldrk.fwcs").value=document.getElementById("ldrk_fwcs").value;
		}
		if($('#czrk.fwcs').val()==''||$('#czrk.fwcs').val()==null||$('#czrk.fwcs').val()=="undefined"){
			document.getElementById("czrk.fwcs").value=document.getElementById("czrk_fwcs").value;
		}
		if($('#jzrk.fwcs').val()==''||$('#jzrk.fwcs').val()==null||$('#jzrk.fwcs').val()=="undefined"){
			document.getElementById("jzrk.fwcs").value=document.getElementById("jzrk_fwcs").value;
		}
		if($('#jwry.gzdwmc').val()==''||$('#jwry.gzdwmc').val()==null||$('#jwry.gzdwmc').val()=="undefined"){
			document.getElementById("jwry.gzdwmc").value=document.getElementById("jwry_gzdwmc").value;
		}
		if($('#wlczrk.fwcs').val()==''||$('#wlczrk.fwcs').val()==null||$('#wlczrk.fwcs').val()=="undefined"){
			document.getElementById("wlczrk.fwcs").value=document.getElementById("wlczrk_fwcs").value;
		}
