...
<body class="easyui-layout" data-options="fit:true">
 <div data-options="region:'center',border:false">
       ...
       <div data-options="region:'center',split:true,title:'',border:false" style="height:auto">
		<table id="dgNvrModify" class="easyui-datagrid" data-options="url:'<%=basePath %>nvrInfo/pageQueryNvr',toolbar:'#datagridToolbar',
		            method:'post',
		            singleSelect:true,
		            rownumbers:true,
		            selectOnCheck:true,
...
<script type="text/javascript">
    ...
    //操作列
 	...
 	function doDelete(linkObject, index) {
		...
		var rowSet = $('#dgNvrModify').datagrid('getData');
		var rowData = rowSet.rows[index];
		
		var editUrl = contextPath+"/nvrInfo/queryNvrInfoById/"+rowData.id;
		//alert(editUrl);
