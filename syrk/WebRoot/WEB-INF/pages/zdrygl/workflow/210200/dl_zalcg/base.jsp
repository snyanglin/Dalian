...
<input class="easyui-validatebox inputreadonly" type="text" id="sqyj" name="sqyj"  value="${sqyj}"  style="width: 619px;" data-options="required:false,validType:['maxLength[100]','unnormal']"  readonly="readonly"/></td>
</tr>
