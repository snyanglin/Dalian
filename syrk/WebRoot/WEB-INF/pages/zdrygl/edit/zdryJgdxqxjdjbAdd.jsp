...
<body>
    ...
    <form action="" id="dataForm" name="dataForm" method="post">
	    ...
	    <input type="hidden" id="zdryid" name="zdryid" value="${entity.zdryJgdxqxjdjb.zdryid}" />
	    ...
	    <table border="0" cellpadding="0" cellspacing="10" width="846" align="left">
			<tr class="dialogTr">
	 		...
	 		<tr class="dialogTr">
			  	...
			  	<td width="80%" class="dialogTd" colspan="3"><textarea name="entity.zdryJgdxqxjdjb.qjyy" id="qjyy" class="easyui-validatebox" style="width: 618px; height:48px;"
	    	...
	    	<tr class="dialogTr">
			    ...
			    <td width="30%" class="dialogTd">
			    	<input type="text" name="entity.zdryJgdxqxjdjb.qjrq" id="qjrq" class="easyui-validatebox" style="width: 200px;" value="${entity.qjrq }"
			    ...
			    <td width="30%" class="dialogTd">
			    	<input type="text" name="entity.zdryJgdxqxjdjb.qwxzqhdm" id="qwxzqhdm" value="${entity.qwxzqhdm}" class="easyui-combobox" style="width:200px;"
	    	...
	    	<tr class="dialogTr">
			    ...
			    <td width="80%" class="dialogTd" colspan="3">
			    	<input type="text" name="entity.zdryJgdxqxjdjb.yjfh_rq" id="yjfh_rq" class="easyui-validatebox" style="width: 200px;" value="${entity.yjfh_rq}" 
	 		...
	 		<tr class="dialogTr">
			  	...
			  	<td width="80%" class="dialogTd" colspan="3"><textarea name="entity.zdryJgdxqxjdjb.bz" id="bz" class="easyui-validatebox" style="width: 618px; height:48px;"
	    	...
	    	<tr class="dialogTr">
			    ...
			    <td width="80%" class="dialogTd" colspan="3">
			   		<input class="easyui-combobox" type="text" id="spjg" name="entity.zdryJgdxqxjdjb.spjg" style="width:200px;" value="${entity.spjg}"
		    ...
		    <tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3">
		    		<input class="easyui-validatebox" type="text" id="spyj" name="entity.zdryJgdxqxjdjb.spyj" style="width: 618px;" value="${entity.spyj}" data-options="required:false,validType:['maxLength[100]','unnormal'],tipPosition:'left'"/>
		    	</td>
		   	</tr>
		   	<td width="20%" class="dialogTd" align="right">请假审批日期：</td>
		    	<td width="30%" class="dialogTd">
		    		<input class="easyui-validatebox" type="text" name="entity.zdryJgdxqxjdjb.spsj" id="spsj" style="width: 200px;" value="${entity.spsj}"/>
		    	</td>
		    	<td width="20%" class="dialogTd" align="right">请假审批人：</td>
		    	<td width="30%" class="dialogTd">
		    		<input class="easyui-validatebox" type="text" name="entity.zdryJgdxqxjdjb.spr_xm" id="spr_xm" style="width: 200px;" maxlength="20" value="${entity.spr_xm}"/>
					<input type="hidden" name="spr_id" id="spr_id" value="${entity.spr_id}"/>
				</td>
		    </tr>
		    <tr class="dialogTr">
	    		<td width="20%" class="dialogTd" align="right">实际返回日期：</td>
			    <td width="30%" class="dialogTd"><input type="text" name="entity.zdryJgdxqxjdjb.sjfh_rq" id="sjfh_rq" class="easyui-validatebox"  style="width: 200px;"/></td>
			   	<td width="20%" class="dialogTd" align="right">销假日期：</td>
			    <td width="30%" class="dialogTd"><input type="text" name="entity.zdryJgdxqxjdjb.xjrq" id="xjrq" class="easyui-validatebox" style="width: 200px;"/></td>
	    	</tr>
	    </table>
