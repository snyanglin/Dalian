...
<body class="easyui-layout" data-options="fit:true">  
    <div data-options="region:'center',border:false">
    	<div class="easyui-layout" data-options="fit:true,border:false">   
            <div data-options="region:'center',split:true,title:'重点人员转递裁定',border:false" style="height:auto">
            	<table id="dg" class="easyui-datagrid" data-options="url: contextPath +'/zdryZd/queryCjList',
...
function processFormater(val, row, index) { // 自定义操作生成
	var hsButton='&nbsp;<a class="link" href="javascript:javascript:void(0)" onclick="doHslg(this,'+index+',\'edit\')">裁定</a>&nbsp;';
...
function doHslg(linkObject, index,openType) {
	...
	var editUrl ="";
		...
		editUrl = contextPath+"/zdryZd/zdryCjApproval?executionId="+rowData.executionId+"&taskId="+rowData.taskId;
	
	//alert(rowData.workflowId);
	var datagrid_ID = getDatagrid_ID(0, linkObject);
	
	openTabPage('重点人员转递裁定', editUrl,datagrid_ID)
}
