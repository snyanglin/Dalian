	...
	<tr><td height="100%" valign="top" align="center">
		...
		<div class="pop_contc">
			...
			<div data-options="region:'center', split:true" style="width:800px; border-width: 0px;">
				...
				<input type="hidden" id="zdrygllxdm" name="zdryZdryzb.zdrygllxdm" value="07/SHB" />
				...
				<table border="0" cellpadding="0" cellspacing="10" width="800px" align="center">
					...
					<tr>
						...
						<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="cyzjdm" name="zdryShbzdryxxb.cyzjdm" value="${cyzjdm}" style="width:200px;"
				    	...
				    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="zjhm" name="zdryShbzdryxxb.zjhm" value="${zjhm}" style="width:200px;float:left;" maxlength="30" 
					...
					<tr class="dialogTr">
		    	        ...
		    	        <td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="xm" name="zdryShbzdryxxb.xm" value="${xm}" style="width:200px;" maxlength="50"
		    	        	data-options="tipPosition:'left',required:true"/></td>
		    	        <td width="20%" class="dialogTd" align="right">性别：</td>
				    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="xbdm" name="zdryShbzdryxxb.xbdm" value="${xbdm}" style="width:200px;" 
				    	...
				    	<td width="20%" class="dialogTd" align="right">出生日期：</td>
		    	 		<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="csrq" name="zdryShbzdryxxb.csrq" value="${csrq}" style="width:200px;" 
				    	...
				    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="mzdm" name="zdryShbzdryxxb.mzdm" value="${mzdm}" style="width:200px;" 
				   ...
				   <tr class="dialogTr">
					...
					<tr class="dialogTr">
		 			...
		 			<tr class="dialogTr">
				    	...
				    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="jgssxdm" name="zdryShbzdryxxb.jgssxdm" value="${jgssxdm}" style="width:200px;" 
				    	...
				    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="hjdsssxdm" name="zdryShbzdryxxb.hjdsssxdm" value="${hjdsssxdm}" style="width:200px;" 
							data-options="mode:'remote',dataFilter:'.*[^00]$',valueField:'id',textField:'text',selectOnNavigation:false,method:'post'"/></td> 
					...
					<tr class="dialogTr">
				    	...
				    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox" type="text" name="zdryShbzdryxxb.hjd_dzms" id="hjd_dzms" value="${hjd_dzms}" style="width:595px;"/>
							<input type="hidden" id="hjd_xzqhdm" name="zdryShbzdryxxb.hjd_xzqhdm" value="${hjd_xzqhdm}"/>
							<input type="hidden" id="hjd_mlpdm" name="zdryShbzdryxxb.hjd_mlpdm" value="${hjd_mlpdm}"/>
							<input type="hidden" id="hjd_mlpxz" name="zdryShbzdryxxb.hjd_mlpxz" value="${hjd_mlpxz}"/>
							<input type="hidden" id="hjd_dzid" name="zdryShbzdryxxb.hjd_dzid" value="${hjd_dzid}"/>
							<input type="hidden" id="hjd_dzxz" name="zdryShbzdryxxb.hjd_dzxz" value="${hjd_dzxz}"/>
				    	</td> 
					</tr>
					<tr class="dialogTr">
					...
					<tr class="dialogTr">
				    	...
				    	<td width="50%" class="dialogTd" colspan="2">
					    	...
					    	<input type="hidden" id="dz_jzdzmlpdm" name="zdryShbzdryxxb.dz_jzdzmlpdm" value="${dz_jzdzmlpdm}"/>
					    	<input type="hidden" id="dz_jzd_mlpxz" name="zdryShbzdryxxb.dz_jzd_mlpxz" value="${dz_jzd_mlpxz}"/>
				    	</td>
				    	<td width="30%" class="dialogTd" align="left">
					    	...
					    	<input type="hidden" id="dz_jzdzdm" name="zdryShbzdryxxb.dz_jzdzdm" value="${dz_jzdzdm}"/>
					    	<input type="hidden" id="dz_jzdzssxdm" name="zdryShbzdryxxb.dz_jzdzssxdm" value="${dz_jzdzssxdm}"/>
					    	<input type="hidden" id="dz_jzdzxz" name="zdryShbzdryxxb.dz_jzdzxz" value="${dz_jzdzxz}"/>
					    	<input type="hidden" id="zrqdm" value="${zrqdm}"/>
				    	</td>
					</tr>
					<tr class="dialogTr">
				    	<td width="20%" class="dialogTd" align="right">居住地社区：</td>
					    <td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="jzd_sq" name="zdryShbzdryxxb.jzd_sq" value="${jzd_sq}" style="width:200px;" 
							data-options="url: contextPath + '/common/dict/D_BZDZ_SQ3.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',tipPosition:'right'"/></td> 
