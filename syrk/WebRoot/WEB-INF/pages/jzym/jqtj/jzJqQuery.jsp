					...
					<tr class="dialogTr">
						<td class="dialogTd" align="center" colspan="4">
								...
								<a href="javascript:void(0)" class="easyui-linkbutton" 
								 ...
								 &nbsp;
								<a href="javascript:void(0)" class="easyui-linkbutton" 
								 iconCls="icon-search" onclick="queryListButton()">查询</a>
								 &nbsp;
								<a href="javascript:void(0)" class="easyui-linkbutton" 
								 iconCls="icon-search" onclick="queryButton()">统计</a>
					</td>
				</tr>					
				</table>
				</form>
...
function queryListButton(){
	...
	if(parseInt(fqsj) > parseInt(jssj)){
		alert("开始时间要大于等于结束时间!");
		return;
	}
	var parm = "?fqsj=" + fqsj + "&jssj=" + jssj + "&gxdwdm=" + orgcode;
	//alert(parm)
...
function queryButton(){
	...
	//var parm = "?fqsj=" + fqsj+" 00:00:00" + "&jssj=" + jssj+" 59:59:59" + "&orgcode=" + orgcode;
	var parm = "?fqsj=" + fqsj + "&jssj=" + jssj+ "&orgcode=" + orgcode;
	//alert(parm)
	window.parent.zdParm(parm, "jqtj");
}
