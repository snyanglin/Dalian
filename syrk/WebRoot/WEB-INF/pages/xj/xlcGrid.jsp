     ...
     //此处用于给金万码传月份参数 end
      function init(){
       ...
       function openPCS(val,row,index){
	  		...
	  		return "<div class='dbrwck' ><a href='javascript:void(0)' onclick='menu_open(\"巡逻车考核排名明细\", \""+url+"\")')>"+val+"</a></div>";
	    }
	    ...
	    function getScore(val,row,index){
			...
			return "<div class='dbrwck' ><a href='javascript:void(0)' onclick='menu_open(\"巡逻车考核明细\", \""+url+"\")')>"+val+"</a></div>";
	    }
      ...
      function isGrade(flags) {
    		var data = [];
   			...
   			datac = [[    
   		        {field:"userName",title:"巡逻车牌号",width:95,align:"center",halign:'center'},
       		...
       		datagrid("#xlcGrid", url, datac, "2", flags);
