     ...
     //此处用于给金万码传月份参数 end
      ...
      function isGrade(type) {
    		if("grid" == type){
    			...
    			document.getElementById("xlyGrid").src = "<%=request.getContextPath()%>/forward/xj|xlyGrid?flag=" + flags;
    			document.getElementById("xlcGrid").style.display = "";
    			document.getElementById("xlcGrid").src = "<%=request.getContextPath()%>/forward/xj|xlcGrid?flag=" + flags;
    			document.getElementById("xqGrid").style.display = "";
   				document.getElementById("xqGrid").src = "<%=request.getContextPath()%>/forward/xj|xqGrid?flag=" + flags;
    		}else{
