...
<body  class="easyui-layout" data-options="fit:true">
				 ...
				 <form action="<%=basePath%>xsjbxxb/saveFC" id="jbxxForm" name="jbxxForm" method="post" >
			    	  ...
			    	  <table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
			    	      ...
			    	      <tr class="dialogTr">
								...
								<td width="20%" class="dialogTd" align="right">手机号码：</td>
						    	<td width="30%" class="dialogTd">
			    	  	...
			    	  	<tr class="dialogTr">
		    	      		...
		    	      		<td width="" class="dialogTd"  colspan="3">
					    		<input class="easyui-validatebox" type="text" readOnly="readOnly" name="jbrlxfs" value="${entity.jbrlxfs}" 
				    	 ...
				    	 <c:forEach var="item" items="${listlxfs}" varStatus="i">
		    	      	 ...
		    	      	 -->
			    	      <tr class="dialogTr">
						    	<td width="20%" class="dialogTd" align="right">出租车车牌：</td>
						    	<td width="30%" class="dialogTd">
			    	      ...
			    	      <tr class="dialogTr">
								...
								<td width="25%" class="dialogTd" align="right">举报信息性质：</td>
						    	<td width="30%" class="dialogTd">
		       		    ...
		       		    <tr class="dialogTr">
		    				...
		    				<td width="20%" class="dialogTd" align="right">线索发现地址：</td>
							 <td width="30%" class="dialogTd" colspan="2">
								  <input class="easyui-combobox" id="jzd1" style="width:400px;" value="${entity.xsdzmlpxz}" data-options="required:false,mode:'remote',method:'post',panelHeight: 22,valueField:'id',textField:'text',selectOnNavigation:false">
			    	    ...
			    	    <!-- ************************************************* -->
			    	      <tr class="dialogTr" id="mapZRQ">
				    	    ...
				    	    <td width="" class="dialogTd" align="right" colspan="3">
			   		      ...
			   		      <tr class="dialogTr">
								<td width="40%" class="dialogTd" align="right">线索地址描述：</td>
						    	<td width="60%" class="dialogTd" colspan="3" >
						    		<textarea id="xsdzms" name="xsdzms" class="easyui-validatebox" style="width: 660px; height:48px;"
									data-options="validType:['maxLength[1000]'],invalidMessage:'线索地址描述不能超过1000个汉字，请重新输入！',tipPosition:'left'" >${entity.xsdzms}</textarea>
								</td>
			    	      </tr>
			    	      <tr class="dialogTr">
						    	<td width="40%" class="dialogTd" align="right">举报内容：</td>
						    	<td width="60%" class="dialogTd" colspan="3" >
						    		<textarea id="jbnr" name="jbnr" class="easyui-validatebox" style="width: 660px; height:48px;"
			    	      ...
			    	      <!-- ***************************************************************************************************** -->
			    	      <tr class="dialogTr">
						    	<td width="20%" class="dialogTd" align="right">初查结果：</td>
			    	      ...
			    	      <tr class="dialogTr" id="ajckglaj" >
				    	    <td width="40%" class="dialogTd" align="right"></td>
			    	       ...
			    	       <tr class="dialogTr" id ="ccbzTr">
						    	<td width="40%" class="dialogTd" align="right">原因说明：</td>
						    	<td width="60%" class="dialogTd" colspan="3" >
			    	      ...
			    	      <tr class="dialogTr" id="dzdz" >
		    				...
		    				<td width="20%" class="dialogTd" align="right">递转地址：</td>
							 <td width="30%" class="dialogTd" colspan="2">
			    	    ...
			    	    <tr class="dialogTr" id="dzdzbz" >
							...
							<td width="60%" class="dialogTd">
			   		      ...
			   		      <tr class="dialogTr" id="dzdzddms">
								<td width="40%" class="dialogTd" align="right">地点描述：</td>
						    	<td width="60%" class="dialogTd" colspan="3" >
			    	      ...
			    	      <!-- ***************************************************************************************************** -->      
			    		   <tr class="dialogTr">
						    	<td width="20%" class="dialogTd" align="right">复查结果：</td>
						    	<td width="80%" class="dialogTd">
	...
	<div style="float:left;width:300px;border-left:1px #ccc dashed;min-height:200px;">
		<ul class="colli">
			
			<c:forEach var="item" items="${xsdzspb}">
			<li>
				<div>${item.xt_lrsj}由 ${item.spdw}仲裁处理</div>
				<div>处理状态：${item.spzt}</div>
				<div>审批回复：${item.sphf}</div>
			</li>
			</c:forEach>
			<li>该审批${xsdzsqb.sqsj}由${xsdzsqb.xt_lrrbm}单位的${xsdzsqb.xt_lrrxm}发起仲裁申请</li>
		</ul>
	</div>
</div>
</div>
