...
<body  class="easyui-layout" data-options="fit:true">
	    	  ...
	    	  <table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
	    	      <tr class="dialogTr">
				    	...
				    	<td width=300"" class="dialogTd">
				    		<a class="link" href="javascript:javascript:void(0)" onclick="viewXs()">${xsjbxxb.id}</a>
				    		<input type='hidden' class="easyui-validatebox" id="xsbh" name="xsbh" readOnly="readOnly" value="${xsjbxxb.id}" 
				    		style="width:300px;" />
				    	...
				    	<td width="300" class="dialogTd">
				    		...
				    		<input type='hidden' class="easyui-validatebox" type="text" id="ajbh" name="ajbh" readOnly="readOnly" value="${ajxxb.ajbh}"
	    	      ...
	    	      <tr class="dialogTr">
				    	...
				    	<td  class="dialogTd">
				    		...
				    		style="width300px;" data-options="required:true,url: contextPath + '/common/dict/D_BZ_XSLX.js',
				    		valueField:'id',textField:'text',selectOnNavigation:false,method:'get'"/>
						</td> 
					...
					<tr class="dialogTr">
    					...
    					<td  class="dialogTd" align="right">线索发现地址：</td>
					 	<td  class="dialogTd" colspan="2">
						  	<input class="easyui-combobox" id="jzd1" style="width:560px;" readOnly="readOnly" value="${xsjbxxb.xsdzmlpxz}" data-options="required:false,mode:'remote',method:'post',panelHeight: 22,valueField:'id',textField:'text',selectOnNavigation:false">
					...
					<tr class="dialogTr">
				    	<td class="dialogTd" align="right" valign="top">内容：</td>
				    	<td  class="dialogTd" colspan="3" >
				    		<textarea id="jlxxbbz" name="jlxxbbz" class="easyui-validatebox" style="width:870px; height:48px;"
						...
						<td  class="dialogTd" align="right">办案单位：</td>
						  	<td  class="dialogTd">
						  		<input class="easyui-validatebox" type="text" id="xt_lrrbm" readOnly="readOnly" name="xt_lrrbm"
							 			maxlength="100" style="width:300px;" value="${ajxxb.xt_lrrbm} "/>
							 </td>
							 <td  class="dialogTd" align="right">办案民警：</td>
					  	<td  class="dialogTd">
					  		<input class="easyui-validatebox" id="xt_lrrxm" name="xt_lrrxm" readOnly="readOnly"
					  		style="width:300px;" value="${ajxxb.xt_lrrxm}"/>
						</td> 
			        </tr>
		    	    <tr class="dialogTr">
				    	<td  class="dialogTd" align="right" valign="top">查证处理结果：</td>
				    	<td  class="dialogTd" colspan="3" >
				    		<textarea id="slfzcljg" name="slfzcljg" class="easyui-validatebox" style="width:870px; height:48px;"
							data-options="validType:['maxLength[1000]'],invalidMessage:'举报内容不能超过1000个汉字，请重新输入！',
		    	    ...
		    	    <tr class="dialogTr" id = "slzcljgTr">
				    	...
				    	<td  class="dialogTd" colspan="3" >
				    		<textarea id="slzcljg" name="slzcljg" class="easyui-validatebox" style="width:870px; height:48px;"
							data-options="validType:['maxLength[1000]'],invalidMessage:'举报内容不能超过1000个汉字，请重新输入！',
		    	    ...
		    	    <tr class="dialogTr" id="slzxcljgTr" >
				    	...
				    	<td class="dialogTd" colspan="3" >
				    		<textarea id="slzxcljg" name="slzxcljg" class="easyui-validatebox" style="width:870px; height:48px;"
							data-options="validType:['maxLength[1000]'],invalidMessage:'举报内容不能超过1000个汉字，请重新输入！',
		    	    ...
		    	    <tr id="jljeTr">
						...
						<td  class="dialogTd">
					  		<input class="easyui-validatebox" id="jlje" name="jlje" "
					  		style="width:300px;data-options="validType:['money']"" value="${jlxxb.jlje }"/>
						</td>
					</tr>
	    	      <tr class="dialogTr">
				    	...
				    	<td  class="dialogTd">
				    	<c:choose>
				    		<c:when test="${orglevel == '02'}">
				    			<a id="" class="l-btn l-btn-small" href="javascript:void(0)" group="" onclick="uploadFileEdit('YJJB_JBXXB', '${jlxxb.id}', '0')">
		...
		<div id="saveDiv" style="text-align:center; height:50px; padding-top: 10px; display:block;">
			<a id="doTY"  class="l-btn l-btn-small" href="javascript:void(0)" group="">
				<span class="l-btn-left l-btn-icon-left">
					<span class="l-btn-text">同 意&nbsp;&nbsp;</span>
				</span>
			</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a id="doJJ"  class="l-btn l-btn-small" href="javascript:void(0)" group="">
				<span class="l-btn-left l-btn-icon-left">
					<span class="l-btn-text">拒 绝&nbsp;&nbsp;</span>
				</span>
			</a>
			...
			<a id="resetBotton" class="l-btn l-btn-small" href="javascript:void(0)" group="">
				<span class="l-btn-left l-btn-icon-left">
					<span class="l-btn-text">重 置&nbsp;&nbsp;</span>
					<span class="l-btn-icon icon-reset"> </span>
				</span>
			</a>
			
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a id="doDY"  class="l-btn l-btn-small" href="javascript:void(0)" group="">
				<span class="l-btn-left l-btn-icon-left">
					<span class="l-btn-text">打印申请表&nbsp;&nbsp;</span>
				</span>
			</a>
		</div>
</td>
...
$(function(){
	...
	function doDYSPY(){
		// 测试格式
		var hsUrl = contextPath+"/jbjlspb/openDY?";
		hsUrl+="id="+"${jbjlspb.id}";
		window.open(hsUrl);
		...
		$.post(hsUrl,{id:'${jbjlspb.id}'},function(d){
			if(d.status){
				//topMessager.show("",d.message);
				//alert(d.message);
				//location.href = contextPath+"/zpfjFjxxb/download?id="+d.message;
				var $form = $('<form action="'+contextPath+'/zpfjFjxxb/download" method="post"><input type="hidden" name="id" value="'+d.message+'"/></form>');
				$('body').append($form);
				$form.submit();
			}else{
				topMessager.alert(d.message);
			}
		},'json');
	...
	function editFile(){
		uploadFileEdit('YJJB_JBXXB','${jlxxb.id}','0')
	}
	//查看案件
	function viewCase(){
		if('${ajSource}'=='0'){
