...
<body class="easyui-layout" data-options="fit:true">
			    	  ...
			    	  <table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
			    	    ...
			    	    <!-- ************************************************* -->
			    	      <tr class="dialogTr" id="mapZRQ">
				    	    ...
				    	    <td width="" class="dialogTd" align="left" colspan="3">
			    	      ...
			    	      <tr class="dialogTr">
						    	...
						    	<td class="dialogTd" colspan="3" >
						    		<textarea id="jbnr" name="jbnr" class="easyui-validatebox" style="width: 750px; height:180px;"
	...
	<div style="float:left;width:250px;min-height:200px;margin-left:25px;*margin-left:5px;">
		<ul class="colli">
			...
			<li>
				<div>时间：${entitySq.sqsj}</div>
				<div>操作：${entitySq.xt_lrrbm}的${entitySq.xt_lrrxm}向${zcfqdwUpName}发起递转申请</div>
			</li>
		</ul>
	</div>
</div>
