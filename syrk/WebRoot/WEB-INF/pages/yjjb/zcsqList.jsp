  ...
  <body class="easyui-layout" data-options="fit:true">
	    <div data-options="region:'center',border:false">
	    	<div class="easyui-layout" data-options="fit:true,border:false">   
	            <div data-options="region:'center',split:true,title:'递转申请列表',border:true" style="height:auto">
				<table id="dg" class="easyui-datagrid" data-options="url:'<%=basePath %>xszcsqb/query',toolbar:'#datagridToolbar',
				            singleSelect:false,
					...
					<thead>
					    <tr>
					        ...
					        <th data-options="field:'zcfqdw', width:20, align:'center', halign:'center' ,sortable:true, formatter:dictFormatter,dictName:'<%=basePath %>common/myOrg?type=ZCSQ'">申请单位</th>
						...
						<table cellspacing="0" cellpadding="0" border="0" width="100%" >
							<tbody>
								...
								<tr>
									...
									<td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
									<td class="toolbarTd" style="width:280px">
										申请单位：<input class="easyui-combobox" type="text" name="zcfqdw" id="zcfqdw" 
												data-options="required:false,url: '<%=basePath %>common/myOrg?type=ZCSQ',
			    						valueField:'id',textField:'text',selectOnNavigation:false,method:'get'" style="width:160px;" />
									</td>
									<td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
									<td class="toolbarTd" style="width:250px;padding-right:8px">
