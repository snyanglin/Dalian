...
<head>
    ...
    <!--
	    ...
	    function queryButton(){
	    	var context = document.getElementById("ywxtgzrwmc").value;
  ...
  <div data-options="region:'center',border:false">
    	<div class="easyui-layout" data-options="fit:true,border:false">
  			...
  			<table id="rwlb" class="easyui-datagrid" 
			    ...
			    <thead>
			        <tr>
			            <th data-options="field:'ywxtgzrwmc',width:200,align:'left',sortable:true,halign:'center',formatter:dbrwStyler">协同内容</th>
			            ...
			            <th  data-options="field:'rwcljgdm',width:100,align:'left',halign:'center',sortable:true">处理结果</th>
			        	<th data-options="field:'cjsj',width:100,align:'center',sortable:true,halign:'center'">裁决时间</th>
			            <th  data-options="field:'cjjgdm',width:50,align:'center',halign:'center',sortable:true">裁决结果</th>
			            <!-- 
  			...
  			<div id="datagridToolbar" style="padding:5px;height:80">
	  			<form id ="queryForm">
	   			<table border="0" cellpadding="0" cellspacing="10" width="100%"	align="center">
					<tr>
						<td width="100" nowrap="nowrap" align="right">协同内容：</td>
						<td width="180">
							<input type="text" name="ywxtgzrwmc" id="ywxtgzrwmc" class="easyui-validatebox" style="width:260px" 
								value="${entity.ywxtgzrwmc}" data-options="required:false,tipPosition:'bottom'" maxlength="100"/>
						</td>
						<!-- 
						...
						<td width="180"><input class="easyui-combobox" type="text" id="rwzt" name="rwzt" style="width:260px" value="${entity.rwzt}"
						 ...
						 -->
						<td width="100" nowrap="nowrap" align="right">发起时间起：</td>
						<td width="180">
							<input type="text" name="fqsj" id="fqsj" class="easyui-validatebox"  style="width:70px" 
							...
							至
							<input type="text" name="jssj" id="jssj" class="easyui-validatebox" style="width:70px" 
							 	onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" data-options="required:false,tipPosition:'left',
							 	validType:['date[\'yyyy-MM-dd\']']" style="" value="${entity.rwjssj}"/>
						</td>
						<td width="100" nowrap="nowrap" align="right">发起部门：</td>
						<td width="180">
					...
					<tr>
						<td width="100" nowrap="nowrap" align="right">接收部门：</td>
						<td width="180">
						...
						<td width="100" nowrap="nowrap" align="right">处理结果：</td>
						<td width="180">
						...
						<td width="100" nowrap="nowrap" align="right">裁决结果：</td>
						<td width="180"><input type="text" name="cjjgdm" id="cjjgdm" class="easyui-validatebox" style="width:260px" 
