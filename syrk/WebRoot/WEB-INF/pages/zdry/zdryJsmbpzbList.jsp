       		...
       		getAutoPageSize(300) * 2]">
    			<thead>   
			        <tr>   
			        	...
			        	<th data-options="field:'zdrygllxdm',width:250,align:'center',fixed:true,formatter:dictFormatter,dictName:contextPath+'/common/dict/BD_D_ZDRYLBDM.js'">重点人员类型代码</th>
				...
				<form id="queryForm">
					<table cellspacing="4" cellpadding="4" border="0">
						<tbody>
							<tr>
								<td class="toolbarTd">
									重点人员管理类型：<input type="text" name="zdrygllxdm" id="zdrygllxdm" class="easyui-combobox" data-options="required:false,url: contextPath + '/common/dict/BD_D_ZDRYLBDM.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',tipPosition:'left'" style="width:200px" />
								</td>
								<td class="toolbarTd">
