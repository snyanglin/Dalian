			...
			<table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
				...
				<tr class="dialogTr">
					...
					<td width="30%" class="dialogTd" >
						<input type="text" name="zdrygllxdm" id="zdrygllxdm" class="easyui-combobox" value="${entity.zdrygllxdm}" data-options="required:true,url: contextPath + '/common/dict/BD_D_ZDRYLBDM.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',tipPosition:'left'" style="width:200px" />
					</td>
					<tr class="dialogTr">
