...
%>	    
		    <!-- 监管对象 -->
		    <table id="jgdxDiv" border="0" cellpadding="0" cellspacing="10" width="100%" align="center" style="margin-top: -10px;">
		    <tr class="dialogTr">
		    ...
		    <!-- 重点人口 -->
		    <table id="zdrkDiv" border="0" cellpadding="0" cellspacing="10" width="100%" align="center" style="margin-top: -10px;">
	    	<tr class="dialogTr">
	    	...
	    	<!-- 肇事肇祸精神病人 -->
	    	<table id="zszhjsbrDiv" border="0" cellpadding="0" cellspacing="10" width="100%" align="center" style="margin-top: -10px;">
	    	<tr class="dialogTr">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3"><textarea name="zdryZszhjsbrxxb.wxxpgdj" id="wxxpgdj" class="easyui-validatebox" style="width: 619px; height:48px;"
		    ...
		    <td width="80%" class="dialogTd" colspan="3">
		    	<input class="easyui-validatebox" type="text" id="zsdd" name="zdryZszhjsbrxxb.zsdd" maxlength="100" style="width: 619px;" data-options="required:false" value="${zdryVO.zdryZszhjsbrxxb.zsdd}"/>
		    	</td>
	    	</tr>
	    	...
	    	<!-- 非正常访人员 -->
	    	<table id="fzcfryDiv" border="0" cellpadding="0" cellspacing="10" width="100%" align="center" style="margin-top: -10px;">
	    	<tr class="dialogTr">
	    	...
	    	<!-- 社区矫正人员 -->
	    	 <table id="sqjzryDiv" border="0" cellpadding="0" cellspacing="10" width="100%" align="center" style="margin-top: -10px;">
		
		    <tr class="dialogTr">
	    		<td width="20%" class="dialogTd" align="right">监管单位机构名称：</td>
		    	<td width="80%" class="dialogTd"><input type="text" readonly="readonly" name="zdrySqjzryxxb.jgdw_gajgmc" id="jgdw_gajgmc" class="easyui-validatebox inputreadonly" style="width: 619px;" maxlength="50"  value="${zdryVO.zdryZszhjsbrxxb.jdjg}"
		    	data-options="validType:['maxLength[50]'],tipPosition:'right'" /></td>
	    	</tr>
			<tr class="dialogTr">
				<td width="20%" class="dialogTd" align="right">犯罪性质：</td>
				<td width="80%" class="dialogTd" colspan="3"><input class="easyui-combotree" type="text" id="fzxzdm" name="zdrySqjzryxxb.fzxzdm" style="width:619px;" value="${zdryVO.zdryJgdxxxb.fzxzdm}" delayParse="true"
					data-options="url: contextPath + '/common/dict/DL_D_FZXZDM.js',onlyLeaf:false,dataFilter:'^01|^02|^03|^04|^05|^06|^07|^08|^09|^10|^91|^92|^93|^94|^95|^96|^99999',multiple:false,method:'get',editable:true,lines:true"/>
				</td>
			</tr>
			 <tr class="dialogTr"> 
		    ...
		    <tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd"><input type="text" name="zdrySqjzryxxb.pjjgmc" id="sqjzrypjjgmc" class="easyui-validatebox" style="width: 619px;" maxlength="50"  value="${zdryVO.zdryZszhjsbrxxb.jdjg}"
	    	...
	    	<tr>
	     	...
	     	<tr id="scpjs">
	    	  ...
	    	  <!-- 涉枪涉爆重点人员 -->
		    <table id="sqsbzdryDiv" border="0" cellpadding="0" cellspacing="10" width="100%" align="center" style="margin-top: -10px;">
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">重点人员管理方法：</td>
...
function zdrylxChange(newVal,oldVal){
		...
		$.ajax({
			async:false,
			type:"POST",
			url:"<%= basePath%>zdryLcg/getYlgZdrylbdm",
			dataType:"json",
			data:"syrkid="+$("#syrkid").val(),
			success:function(data){
			if (data) {
					$('#zdrylbStr').combotree('tree').tree('setDataFilter', '^('+newVal+'(?!('+data+')))');
				}else{
					//setInputReadonly("zdrylbStr", true);
					$('#zdrylbStr').combotree('tree').tree('setDataFilter', '^'+newVal);
				}
			...
			if(placeVersion=="辽宁省厅版"){
				...
				if(newVal == "01") {
					...
					setComboRequired("sqjzrypjjgmc",true);
					setComboRequired("sqjzryky_jzrq",true);
					...
					setComboRequired("sqjzrypjjgmc",false);
					setComboRequired("sqjzryky_jzrq",false);
				...
				if(newVal == "01") {
				 ...
				 if(newVal == "09"||newVal == "07"||newVal == "08"){
						$("#jgdxDiv").hide();
						$("#zdrkDiv").hide();
						$("#zszhjsbrDiv").hide();
						$("#fzcfryDiv").hide();
