       		...
       		getAutoPageSize() * 2]">
    			<thead>   
			        <tr>   
			        	...
			        	<th data-options="field:'zdrygllxdm',width:200,align:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/BD_D_ZDRYLBDMLIST_MUNICIPAL.js'">重点人员管理类型</th>
