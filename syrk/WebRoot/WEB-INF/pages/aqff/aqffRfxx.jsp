...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=contextPath%>/js/aqff/rfxx/aqffRfxx.js"></script>
	</head>
   ...
   <div data-options="region:'center',border:false">
    	<div class="easyui-layout" data-options="fit:true,border:false">   
            <div data-options="region:'center',split:true,title:'',border:false" style="height:auto;overflow:hidden;">
            	...
            	data-options="url:'<%=basePath %>rfxxb/queryMHRf',
				    ...
				    <thead>
				        <tr>
				            <th data-options="field:'ffzzxsdm',width:5,align:'center' ,sortable:true,halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_ZAFF_ZZXS.js'">组织形式</th>
				...
				<table border="0" cellpadding="0" cellspacing="10" width="100%"	align="center">
					<tr>
						...
						<td>
							<a href="javascript:void(0)" class="easyui-linkbutton"  iconCls="icon-add"  onclick="rfAdd();">新增</a>
						</td>
					</tr>
				</table>
				</div>
    ...
    <!-- 精确查询框 -->
    <div id="win" class="easyui-window" title="人防信息精确查询" style="width:400px;height:600px;top:20px;display:none;"   
			        ...
			        <table border="0" cellpadding="0" cellspacing="10" width="100%" height="80%" align="center">
			        	<tr class="dialogTr">
					   	...
					   	<tr class="dialogTr">
					    	...
					    	<td width="70%" class="dialogTd">
								<input class="easyui-validatebox" type="text" id="ffzrrzjhm" name="ffzrrzjhm"
								style="width:150px;"
								data-options="required:false,validType:'maxLength[20]'"/>
							</td>
					   	</tr>	
				       ...
				       <tr class="dialogTr">
					    ...
					    <tr class="dialogTr">
					    	...
					    	<td width="70%" class="dialogTd"><input type="text" id="ffzzxsdm" name="ffzzxsdm" class="easyui-combobox"  style="width:150px;"
					    		 data-options="required:false,url: contextPath + '/common/dict/D_ZAFF_ZZXS.js',
				    			valueField:'id',textField:'text',selectOnNavigation:false,method:'get',tipPosition:'right',onSelect:function(newValue,oldValue){}"/>
					    	</td>
					    </tr>	
					   <tr class="dialogTr">
					    ...
					    <tr class="dialogTr">
					    	...
					    	<td width="70%" class="dialogTd">
					    		<input class="easyui-validatebox" type="text" id="dz_zzdzmlpxz" name="dz_zzdzmlpxz" style="width:150px;"
								data-options="required:false,validType:'maxLength[20]'"/>
							</td>
					    </tr>
	...
	<!--   <div id="winDel" class="easyui-window" title="注销原因" style="width:215px;height:170px;top:20px;display:none;"   
        data-options="iconCls:'icon-search',
        collapsible:false,
        minimizable:false,
        maximizable:false,
		...
		height:100px;overflow: auto;" data-options="required:false,validType:['maxLength[100]'],
		...
		<a  class="easyui-linkbutton"  iconCls="icon-cancel"  onclick="del_div_qx()" >取消</a>
	</div> -->  
	<div id="winDel" class="easyui-window" title="人防注销" style="width:500px;height:200px"   
      data-options="iconCls:'icon-save',modal:true,closed:true,collapsible:false,minimizable:false, maximizable:false"> 
      	<table border="0" cellpadding="0" cellspacing="10" width="100%" height="100%" align="center">
      		<tr>
	      		<td align="left"> 
		      		<!--  <input type="hidden" id ="id" value=""> -->  注销原因：
	      		</td>
	      	</tr
	      	<tr>
	      		<td align="center"> 
		      		<!--  <input type="hidden" id ="id" value=""> -->  
		       		<textarea id="xt_zxyy"  title="添加注销原因" onblur="checks(this);"
		       			class="easyui-validatebox" style="width: 423px; height:82px;"
						data-options="required:true,validType:['maxLength[100]'],invalidMessage:'注销原因不能超过100个汉字，请重新输入！',tipPosition:'left'"></textarea>
	      		</td>
	      	</tr>
	      	<tr>
	      		<td align="right">
