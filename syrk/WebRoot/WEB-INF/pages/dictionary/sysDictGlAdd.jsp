    ...
    <form action="<%=basePath%>sysDictGl/save" id="dataForm" name="dataForm" method="post">
	    <div data-options="region:'center', split:true" style="border-width: 0px;">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="zdywm" name="zdywm" style="width:200px;" maxlength="20" data-options="required:true,validType:['variable'],charSet:'halfUpper',invalidMessage:'字典英文名必须为合法的变量名称，请重新输入！'"/></td>
		    	<td width="20%" class="dialogTd" align="right">字典中文名：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="zdzwm" name="zdzwm" style="width:200px;" maxlength="20" data-options="required:true,validType:['noMark'],invalidMessage:'字典中文名不能为空且不能包含单引号、双引号、分号，请重新输入！',tipPosition:'left'"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">生成类别：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="zdsclb" name="zdsclb" style="width:200px;"
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="zdsylb" name="zdsylb" style="width:200px;"
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="zdywlb" name="zdywlb" style="width:200px;"
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox" type="text" name="zdyybz" style="width: 603px;" maxlength="40"/></td>
	    	</tr>
	    	</table>
	    </div>
    </form>
