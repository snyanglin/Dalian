...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript">
      ...
      function loadChart(){
          /*加载实有人口饼状图*/
 	      swfobject.embedSWF(contextPath+"/js/tools/flashChart/open-flash-chart.swf","syrkChart","100%","450px;","9.0.0","expressInstall.swf",{"data-file":contextPath+"/ldym/querySyrkChart?zzjgdm=<%=userOrgCode%>"},{wmode:"transparent"});
       	  /*加载工作对象柱状图*/
       	  swfobject.embedSWF(contextPath+"/js/tools/flashChart/open-flash-chart.swf","gzdxChart","100%","450px;","9.0.0","expressInstall.swf",{"data-file":contextPath+"/ldym/queryGzdxChart?zzjgdm=<%=userOrgCode%>"},{wmode:"transparent"});
       	  /*加载标准地址饼状图*/
       	  ...
       	  /*加载流动人口柱状图*/
       	  swfobject.embedSWF(contextPath+"/js/tools/flashChart/open-flash-chart.swf","ldrkChart","100%","450px;","9.0.0","expressInstall.swf",{"data-file":contextPath+"/ldym/queryLdrkChart?zzjgdm=<%=userOrgCode%>"},{wmode:"transparent"});
       	  /*加载境外人口柱状图*/
       	  ...
       	  /*加载年龄段柱状图*/
       	  swfobject.embedSWF(contextPath+"/js/tools/flashChart/open-flash-chart.swf","nlChart","100%","450px;","9.0.0","expressInstall.swf",{"data-file":contextPath+"/ldym/queryNlChart?zzjgdm=<%=userOrgCode%>"},{wmode:"transparent"});
       	  /*加载文化程度柱状图*/
