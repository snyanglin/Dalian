    ...
    <!--
     ...
     //此处用于给金万码传月份参数 end
      ...
      function openPCS(val,row,index){
    		...
    		return "<div class='dbrwck' ><a href='javascript:void(0)' onclick='menu_open(\"巡逻员考核排名明细\", \""+url+"\")')>"+val+"</a></div>";
      }
      ...
      function getScore(val,row,index){
  		...
  		return "<div class='dbrwck' ><a href='javascript:void(0)' onclick='menu_open(\"巡逻员考核明细\", \""+url+"\")')>"+val+"</a></div>";
      }
      ...
      function isGrade(flags) {
    		...
    		var dataq = [];
   			data = [[    
   		        {field:"userName",title:"巡逻员姓名",width:95,align:"center",halign:'center'},
				...
				{field:"userid",title:"userid",width:95,align:"center",halign:'center',hidden:true}
   		    ]];
