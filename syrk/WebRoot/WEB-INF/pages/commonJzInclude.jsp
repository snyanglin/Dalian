...
<!-- 
<link type="text/css" rel="stylesheet" href="<%=contextPath%>/common/jeasyui/themes/metro-green/easyui.css">
 -->
<link type="text/css" rel="stylesheet" href="<%=contextPath%>/common/jeasyui/themes/metro-blue/easyui.css">
