...
function doInit(paramArray) {
	...
	setInputReadonly('identitycard', true);
	setInputReadonly('industrialid', true);
	setInputReadonly('nation', true);
	setInputReadonly('sex', true);
	setInputReadonly('birthday', true);
	setInputReadonly('telephone', true);
	setInputReadonly('mobile', true);
	setInputReadonly('theme', true);
	setInputReadonly('email', true);
