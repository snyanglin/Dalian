    ...
    <form action="" id="queryForm" name="queryForm" method="post">
	    <div data-options="region:'center',split:true" style="padding: 6px; border-width: 0px;">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="70%" class="dialogTd"><input class="easyui-combobox" type="text" id="usertype" name="usertype" style="width:200px;"
					data-options="url: contextPath + '/common/dict/D_ORG_USERTYPE.js',dataFilter:'2|3',valueField:'id',textField:'text',selectOnNavigation:false,method:'get'"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	...
		    	<td width="70%" class="dialogTd"><input class="easyui-validatebox" type="text" name="orgname" id="orgname" style="width:200px;"/>
 		    	<input type="button" id="orgbutton" value="选 择" class="dictSearchButton" onClick="window.parent.public_singleSelectOrg('${userManageOrgCode}', '01', '', '', 'orgcode', 'orgname', 'orgid', false, false, '', window, '', '')" />
		    	</td>
	    	</tr>
	    	</table>
	    </div>
