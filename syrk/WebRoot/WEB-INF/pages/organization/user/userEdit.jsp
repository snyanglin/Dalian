	     ...
	     <div data-options="region:'center', split:true" id="formDiv" style="border-width: 0px;">
		    ...
		    <tr class="dialogTr" >
		        ...
		        <td width="30%" class="dialogTd">
					...
					<input type="text" name="userOrgName" id="userOrgName" value="${userOrgName}" style="width:145px;" class="easyui-validatebox"/>
		        ...
		        <td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="usertype" name="usertype" value="${entity.usertype}" style="width:200px;"
					data-options="url: contextPath + '/common/dict/D_ORG_USERTYPE.js',dataFilter:'2|3',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',onChange:usertype_exit"/></td>
		    </tr>
		    <tr class="dialogTr" >
		        ...
		        <td width="30%" class="dialogTd">
					...
					<input type="text" name="managerorgname" id="managerorgname" style="width:145px;" class="easyui-validatebox" value="${managerorgname}"/>
