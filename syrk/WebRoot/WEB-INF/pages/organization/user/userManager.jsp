...
<body class="easyui-layout" data-options="fit:true">  
    <div data-options="region:'center',border:false">
    	<div class="easyui-layout" data-options="fit:true,border:false">   
            <div data-options="region:'center',split:true,title:'人员信息列表',border:false" style="height:auto">
            	<table id="dg" class="easyui-datagrid" data-options="url: contextPath +'/orgUser/queryList',toolbar:'#datagridToolbar',
            		singleSelect:false,selectOnCheck:true,checkOnSelect:true,border:false,sortName:'',sortOrder:'asc',
				    ...
				    <thead>
				        <tr>
				            ...
				            <th data-options="field:'userid',width:40,align:'center',halign:'center',sortable:true">人员帐号</th>
				            <th data-options="field:'username',width:30,align:'center',halign:'center',sortable:true">人员姓名</th>
				            <th data-options="field:'parentorgname',width:50,align:'center',halign:'center'">上级部门名称</th>
				            <th data-options="field:'orgname',width:50,align:'center',halign:'center',sortable:true">所在部门</th>
				            <th data-options="field:'usertype',width:30,align:'center',halign:'center',sortable:true,formatter:dictFormatter,dictName:contextPath+'/common/dict/D_ORG_USERTYPE.js'">人员类型</th>
				            <th data-options="field:'managerorgname',width:50,align:'center',halign:'center'">管理部门</th>
				             <th data-options="field:'industrialid',width:30,align:'center',halign:'center',sortable:true">行业号码（警号）</th>
				            <th data-options="field:'mobile',width:40,align:'center',halign:'center'">移动电话</th>
