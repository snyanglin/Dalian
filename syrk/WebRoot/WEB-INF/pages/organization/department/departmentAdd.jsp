    ...
    <form action="<%=basePath%>orgOrganization/save" id="dataForm" name="dataForm" method="post">
	    ...
	    <div data-options="region:'center', split:true" style="border-width: 0px;">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="orgtype" name="orgtype" value="${entity.orgtype}" style="width:200px;"
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="orgcode" style="width:200px;" maxlength="32" 
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="orgname" style="width:200px;" maxlength="40" 
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="orglevel" name="orglevel" style="width:200px;"
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="orgbiztype" name="orgbiztype" style="width:200px;"
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox" type="text" maxlength="60" name="address" style="width:603px;"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">部门电话：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="linktel" style="width:200px;" maxlength="50" 
		    		data-options="validType:['phone']"/></td>
		    	<td width="20%" class="dialogTd" align="right">部门联系人：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="linkman" style="width:200px;" maxlength="30"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">联系人电话：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="linkmantel" style="width:200px;" maxlength="50" 
		    		data-options="validType:['phone']"/></td>
		    	<td width="20%" class="dialogTd" align="right">部门主页：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="weburl" style="width:200px;" maxlength="512"
		    		data-options="validType:['url'],tipPosition:'left'"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">部门邮箱：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="email" style="width:200px;" maxlength="128" 
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-combobox" type="text" id="xzqh" name="xzqh" style="width:603px;"
