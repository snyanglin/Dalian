    ...
    <form action="<%=basePath%>orgMenu/saveSystem" id="dataForm" name="dataForm" method="post">
		...
		<div data-options="region:'center', split:true" id="formDiv" style="border-width: 0px;">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="systemcode" name="systemcode" value="${entity.systemcode}" style="width:200px;" maxlength="50"
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="systemname" name="systemname" value="${entity.systemname}" style="width:200px;" maxlength="50"
		    		data-options="validType:['noMark'],required:true,tipPosition:'right'"/></td>
		    	<td width="20%" class="dialogTd" align="right">资源系统简称：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="systemnamejc" name="systemnamejc" value="${entity.systemnamejc}" style="width:200px;" maxlength="50"
		    		data-options="validType:['noMark'],required:true,tipPosition:'left'"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">资源系统根访问URL：</td>
		    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox" type="text" id="systemcontexturl" name="systemcontexturl" value="${entity.systemcontexturl}" style="width:603px;" maxlength="200" 
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox" type="text" id="systemloginurl" name="systemloginurl" value="${entity.systemloginurl}" style="width:603px;" maxlength="200" 
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd">
		    		...
		    		<tr>
		    			<td width="180"><input class="easyui-combobox" type="text" id="systemiconbig" name="systemiconbig" value="${entity.systemiconbig}" style="width:180px;"
		    	...
		    	<td width="30%" class="dialogTd">
		    		<table border="0" cellpadding="0" cellspacing="0" width="210">
		    		<tr>
		    			<td width="180"><input class="easyui-combobox" type="text" id="systemicon" name="systemicon" value="${entity.systemicon}" style="width:180px;"
						...
						<td width="30" align="center"><div id="div_systemicon" style="width:16px; height:16px;"></div></td>
					</tr>
					</table>
		    	</td>
	    	</tr>
...
function systemiconbigOnchange() {
	...
	if ("undefined" == typeof systemiconbigValue || systemiconbigValue == "") {
...
function systemiconOnchange() {
	...
	if ("undefined" == typeof systemiconValue || systemiconValue == "") {
