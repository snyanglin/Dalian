    ...
    <form action="<%=basePath%>orgMenu/saveMenu" id="dataForm" name="dataForm" method="post">
		...
		<div data-options="region:'center', split:true" id="formDiv" style="border-width: 0px;">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="menuname" name="menuname" style="width:200px;" maxlength="50" onblur="menuname_onblur()"
		    		data-options="validType:['noMark'],required:true,tipPosition:'right'"/></td>
		    	<td width="20%" class="dialogTd" align="right">菜单级别：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="menulevel" name="menulevel" style="width:200px;"
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox" type="text" id="menuurl" name="menuurl" style="width:490px;" maxlength="200" 
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-combobox" type="text" id="menuopenmode" name="menuopenmode" style="width:200px;"
		    	...
		    	<td width="30%" class="dialogTd">
		    		...
		    		<tr>
		    			<td width="180"><input class="easyui-combobox" type="text" id="menuicon" name="menuicon" style="width:180px;"
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigiconimg1" name="bigiconimg1" style="width:200px;" maxlength="100"
		    		data-options="validType:['imgFile'],tipPosition:'right'"/></td>
		    	<td width="20%" class="dialogTd" align="right">大图标说明1：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigicontext1" name="bigicontext1" style="width:200px;" maxlength="50"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">大图标图片2：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigiconimg2" name="bigiconimg2" style="width:200px;" maxlength="100"
		    		data-options="validType:['imgFile'],tipPosition:'right'"/></td>
		    	<td width="20%" class="dialogTd" align="right">大图标说明2：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigicontext2" name="bigicontext2" style="width:200px;" maxlength="50"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">大图标图片3：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigiconimg3" name="bigiconimg3" style="width:200px;" maxlength="100"
		    		data-options="validType:['imgFile'],tipPosition:'right'"/></td>
		    	<td width="20%" class="dialogTd" align="right">大图标说明3：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigicontext3" name="bigicontext3" style="width:200px;" maxlength="50"/></td>
	    	</tr>
	    	<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">大图标图片4：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigiconimg4" name="bigiconimg4" style="width:200px;" maxlength="100"
		    		data-options="validType:['imgFile'],tipPosition:'right'"/></td>
		    	<td width="20%" class="dialogTd" align="right">大图标说明4：</td>
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="bigicontext4" name="bigicontext4" style="width:200px;" maxlength="50"/></td>
	    	</tr>
	    	<tr class="dialogTr">
...
function doInit(paramArray) {
	...
	if (menutypeValue == "1") {
		...
		$("#menuopenmode").combobox("setValue", "1");
	}
