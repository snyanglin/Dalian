    ...
    <form action="<%=basePath%>orgPosition/save" id="dataForm" name="dataForm" method="post">
	    ...
	    <div data-options="region:'center', split:true" style="border-width: 0px;">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="posid" style="width:200px;" maxlength="100" 
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="posname" style="width:200px;" maxlength="20" 
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="80%" class="dialogTd" colspan="3"><textarea name="posdesc" class="easyui-validatebox" style="width: 603px; height:48px;"
					data-options="validType:['maxLength[200]'],invalidMessage:'岗位描述不能超过200个汉字，请重新输入！',tipPosition:'left'"></textarea></td>
	    	</tr>
	    	<tr class="dialogTr">
