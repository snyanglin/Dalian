    ...
    <div data-options="region:'center',border:false">
    	<div class="easyui-layout" data-options="fit:true,border:false">   
            <div data-options="region:'center',split:true,title:'',border:true" style="height:auto">
            	<table id="dg" class="easyui-datagrid" data-options="url: contextPath +'/sysMessage/queryList?xxlb=2',toolbar:'#datagridToolbar',
				    ...
				    <thead>
				        <tr>
				            ...
				            <th data-options="field:'xxlb',width:10,align:'center',halign:'center',sortable:true,formatter:datagridProcessFormater">信息类别</th>
