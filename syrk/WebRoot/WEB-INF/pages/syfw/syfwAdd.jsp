...
<div data-options="region:'center', split:true" style="border-width: 0px;margin:0 0 0;text-align:center;" class="bodybg">
		...
		<div data-options="region:'center', split:true" style="width:800px; border-width: 0px;">
		    <form action="<%=basePath%>syfw" id="syfwForm" name="dataForm" method="post">
					<table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
						...
						<tr class="dialogTr">
							...
							<td width="50%" class="dialogTd" colspan="2" id="fwdztd">
								<input class="easyui-combobox" id="syfw_fwdz1" style="width:400px;" value="${entity.fwdz_mlpxz}" data-options="required:true,mode:'remote',method:'post',panelHeight: 22,valueField:'id',textField:'text',selectOnNavigation:false">
					    		<input type='hidden' name='fwjbxxb.fwdz_mlpdm' id="syfw_dz_fwmlpdm" value="${entity.fwdz_mlpdm}"/>
					    		<input type='hidden' name='fwjbxxb.fwdz_mlpxz' id="syfw_dz_fwmlpxz" value="${entity.fwdz_mlpxz}"/>
					    		<input type='hidden' name='fwjbxxb.fwdz_zby' id="syfw_fwdz_zby" value="${entity.fwdz_zby}"/>
						...
						<tr class="czfwxx dialogTr">
							...
							<td width="30%" class="dialogTd">	
								<input class="easyui-validatebox" type="text" id="cz_rq" name="czfwxxb.cz_rq" value="" 
							...
							<td width="80%" class="dialogTd" colspan="3">
								<input class="easyui-validatebox" type="text" id="zj" name="czfwxxb.zj" style="width:200px;" value=""
