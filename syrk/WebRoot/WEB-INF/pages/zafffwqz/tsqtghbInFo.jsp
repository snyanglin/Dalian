		...
		<div class="pop_contc">
		 ...
		 <form action="<%=basePath%>fwqz/saveTsqtghb" id="jbxxForm" name="jbxxForm" method="post">
	    	  ...
	    	  <tr class="dialogTr">
				...
				<input type="text" name="ghsj" id="ghsj" class="easyui-validatebox " style="width: 200px;" value="${entity.ghsj}" readonly
				...
				<td width="30%" class="dialogTd" >
				    ...
				    <input class="easyui-validatebox" type="text" id="tsqtlxdm" name="tsqtlxdm" readonly
	    	  	...
	    	  	<tr class="dialogTr">
	    	  		...
	    	  		<td width="80%" class="dialogTd" align="left" colspan="3">
						<input class="easyui-validatebox" type="text" id="ghrdw" name="ghrdw" readonly
				...
				<tr class="dialogTr">
	    	  		...
	    	  		<td width="80%" class="dialogTd" align="left" colspan="3">
						<input class="easyui-validatebox" type="text" id="ghr" name="ghr" readonly
				...
				<tr class="dialogTr">
	    	  		<td width="20%" class="dialogTd" align="right">取得效果：</td>
			    	    <td width="80%" class="dialogTd" colspan="3">
			    	    	<textarea id="qdxg" name="qdxg" class="easyui-validatebox" rows="3" style="width:100%; height:82px;" readonly
				...
				<tr class="dialogTr">
	    	  		<td width="20%" class="dialogTd" align="right">关怀措施：</td>
			    	    <td width="80%" class="dialogTd" colspan="3">
			    	    	<textarea id="ghcs" name="ghcs" class="easyui-validatebox" rows="3" style="width:100%; height:82px;" readonly
