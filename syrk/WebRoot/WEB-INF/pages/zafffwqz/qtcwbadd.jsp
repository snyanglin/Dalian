...
<body style="margin-top:20px"  class="easyui-layout" data-options="fit:true">
		...
		<div class="pop_contc">
		 ...
		 <form action="<%=basePath%>qtcwb/saveQtcwb" id="jbxxForm" name="jbxxForm" method="post">
	    	  ...
	    	  <table border="0" cellpadding="0" cellspacing="10" width="1000px" align="center">
				...
				<table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">  
					<tr class="dialogTr">
				    	...
				    	class="easyui-validatebox" data-options="required:true,tipPosition:'left'"  style="width:200px;float:left;"  maxlength="30"/>
	    	      ...
	    	      <tr class="dialogTr">
	    	       ...
	    	       <tr class="dialogTr" id="jzdz">
	    	        ...
	    	        <tr class="dialogTr">
	    	         	<td width="20%" class="dialogTd" align="right">养宠物用途：</td>
						<td width="30%" class="dialogTd"><input type="text" name="ycwytdm" id="ycwytdm" value="${entity.ycwytdm}" class="easyui-combobox" style="width:200px;"
	    	        ...
	    	        <tr class="dialogTr">
	    	        	<td width="20%" class="dialogTd" align="right">宠物型：</td>
						<td width="30%" class="dialogTd"><input type="text" name="cwx" id="cwx" value="${entity.cwx}" class="easyui-validatebox" style="width:200px;" maxlength="100" 
						/></td>
						<td width="20%" class="dialogTd" align="right">宠物种：</td>
						<td width="30%" class="dialogTd"><input type="text" name="cwz" id="cwz" value="${entity.cwz}" class="easyui-validatebox" style="width:200px;" maxlength="100" 
						/></td>
	    	        </tr>
	    	        <tr class="dialogTr">
	    	        	<td width="20%" class="dialogTd" align="right">宠物龄(月)：</td>
				    	<td width="30%" class="dialogTd">
				    		<input class="easyui-validatebox" type="text" id="cwn" name="cwn"
		    	 			value="${entity.cwn}" maxlength="3" style="width:200px;" data-options="required:false,validType:['naturalNumberRange[1,1000]'],tipPosition:'right'"/>
		    	        </td>
	    	         ...
	    	         <tr class="dialogTr">
				    	...
				    	<td width="30%" class="dialogTd">
				    		<input class="easyui-validatebox" type="text" id="tg" name="tg"
		    	 			value="${entity.tg}" maxlength="3" style="width:200px;" data-options="required:false,validType:['numericRange[\'f\',2,0.00,300]'],tipPosition:'right'"/>
		    	        </td>
					...
					data-options="required:false,validType:['date[\'yyyy-MM-dd\']']" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/></td>
					<td width="20%" class="dialogTd" align="right">养宠物许可证号码：</td>
				    	<td width="30%" class="dialogTd">
				    		<input class="easyui-validatebox" type="text" id="ycwxkzhm" name="ycwxkzhm" maxlength="50"
		    	 			value="${entity.ycwxkzhm}" style="width:200px;" data-options="required:false,tipPosition:'left'"/>
		    	        </td>
	    	        </tr>
	    	        <tr class="dialogTr">
					...
					data-options="required:false,validType:['date[\'yyyy-MM-dd\']']" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/></td>
					  <td width="20%" class="dialogTd" align="right">养宠物许可证有效截止日期：</td>
					<td width="30%" class="dialogTd"><input type="text" name="ycwxkzyxqzrq" id="ycwxkzyxqzrq" value="${entity.ycwxkzyxqzrq}" class="easyui-validatebox"   style="width:200px;"
					data-options="required:false,validType:['date[\'yyyy-MM-dd\']']" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/></td>
	    	        </tr>
	    	        <tr class="dialogTr">
...
$(function(){
		...
		if(flag=="update"){
			...
			setInputReadonly("ycwytdm",true);
			setInputReadonly("wqxwnldm",true);
			setInputReadonly("cwx",true);
			setInputReadonly("cwz",true);
			setInputReadonly("cwn",true);
			...
			setInputReadonly("ycwxkzhm",true);
			setInputReadonly("fzrq",true);
			setInputReadonly("ycwxkzyxqzrq",true);
		...
		$('#saveBotton').click(function(){
			if ($("#jbxxForm").form('validate')){
				topMessager.confirm('操作确认', '您是否保存其它宠物信息？',  function(r) {
					if (r) {							
							$('#jbxxForm').submit();
						}
					});
...
function checkZjhm() {
	...
	$.ajax({
		...
		//	$("#jzd2").combobox('setText', data.ryRyjbxxb.dz_jzdzxz.replace(data.ryRyjbxxb.dz_jzdmlpxz, ''));
