...
<body class="easyui-layout" data-options="fit:true">  
    <div data-options="region:'center',border:false">
    	<div class="easyui-layout" data-options="fit:true,border:false">   
            <div data-options="region:'center',split:true,title:'居住证明管理列表',border:true" style="height:auto">
            	<table id="dg" class="easyui-datagrid" data-options="url: contextPath +'/jzzmb/queryList',
				    ...
				    <thead>
				        <tr>
				        	<th data-options="checkbox:true,align:'center',halign:'center'"></th>
				        	 ...
				        	 <th data-options="field:'dz_hjdzxz',width:50,align:'left',sortable:true,halign:'center'">户籍地址</th>
				        	 <th data-options="field:'dz_jzdzxz',width:50,align:'left',sortable:true,halign:'center'">居住地址</th>
							...
							<tr>
								...
								<tr>
									...
									<td class="toolbarTd" align="left" >
										...
										<a href="javascript:void(0)" class="easyui-linkbutton"  iconCls="icon-add"  onclick="jzzmbAdd(this);">新增</a>
...
function jzzmbAdd(obj){
	var hsUrl = "/jzzmb/addJzzmb?";
	hsUrl+="mainTabID="+getMainTabID();
	openTabPage("居住证明新增",hsUrl);
}
	...
	function doEdit(linkObject, index) {
		...
		var editUrl = "/jzzmb/addJzzmb?id="+rowData.id+"&mainTabID="+getMainTabID();
		openTabPage("居住证明编辑－" + rowData.xm,editUrl);
	...
	function doCk(linkObject, index) {
		...
		var rowData = rows.rows[index];
		var editUrl = "/jzzmb/addJzzmb?id="+rowData.id+"&mainTabID="+getMainTabID();
		openTabPage("居住证明查看－" + rowData.xm,editUrl);
	...
	function doDelete(linkObject, index) {
		cancelBubble(); // 阻止冒泡，不然要执行onClickRow
		var deleteUrl = contextPath + '/jzzmb/delete';
...
function reloadGrid(){
	$('#dg').datagrid("clearSelections");
		...
		var startime = document.getElementById("startime").value;
		var endtime = document.getElementById("endtime").value;
		var reloadUrl = contextPath + '/jzzmb/queryList';
