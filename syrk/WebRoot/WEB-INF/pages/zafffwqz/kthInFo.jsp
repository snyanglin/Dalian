		...
		<div class="pop_contc">
		 ...
		 <form action="<%=basePath%>fwqz/saveKthb" id="jbxxForm" name="jbxxForm" method="post">
	    	  ...
	    	  <tr class="dialogTr">
				...
				<input type="text" name="zksj" id="zksj" class="easyui-validatebox " style="width: 200px;" value="${entity.zksj}" readonly
				...
				<td width="30%" class="dialogTd" >
				    <input class="easyui-validatebox" type="text" id="zzr" name="zzr" readonly
	    	  	...
	    	  	<tr class="dialogTr">
	    	  		...
	    	  		<td width="80%" class="dialogTd" align="left" colspan="3">
						<input class="easyui-validatebox" type="text" id="zzrdw" name="zzrdw" readonly
				...
				<tr class="dialogTr">
	    	  		...
	    	  		<td width="80%" class="dialogTd" align="left" colspan="3">
						<input class="easyui-validatebox" type="text" id="yhr" name="yhr" readonly
				...
				<tr class="dialogTr">
	    	  		<td width="20%" class="dialogTd" align="right">会议内容：</td>
			    	    <td width="80%" class="dialogTd" colspan="3">
			    	    	<textarea id="hynr" name="hynr" class="easyui-validatebox" rows="3" style="width:100%; height:82px;" readonly
