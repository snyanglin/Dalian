...
<%
/******************************************************************************
 * @JSPName:      [dsrxxAdd.jsp]   
 * @Description:  [矛盾-当事人添加页面]   
...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=contextPath%>/js/mdtj/dsr.js"></script>
		<title>当事人新增</title>
		<script>
				...
				<div data-options="region:'center', split:true" style="width:100%; border-width: 0px;">
					<table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
						...
						<tr class="dialogTr">
								...
								<td width="30%" class="dialogTd">
									<input type="text" name="xm" id="xm" value="${entity.xm}" class="easyui-validatebox" data-options="required:true,validType:['maxLength[20]']" style="width:200px;" maxlength="20"/></td>
								...
								<td width="30%" class="dialogTd">
									<input type="text" name="xbdm" id="xb" value="${entity.xbdm}" class="easyui-combobox " style="width:200px;"
												data-options="required:true,url: contextPath + '/common/dict/D_BZ_XB.js',
						...
						<tr class="dialogTr">
								...
								<td width="30%" class="dialogTd">
										<input type="text" name="csrq" id="csrq" value="${entity.csrq}" class="easyui-validatebox"   style="width:200px;"
													data-options="required:true,validType:['date[\'yyyy-MM-dd\']']" 
								...
								<td width="30%" class="dialogTd" >
										...
										data-options="required:false,validType:['phone'],tipPosition:'left' " onblur="checkLxdh('lxdh','ryid')"  /></td>
						</tr>
						<tr class="dialogTr" id="jzdz">
								<td width="20%" class="dialogTd" align="right">居住地址：</td>
								<td width="50%" class="dialogTd" colspan="2">
										<input class="easyui-combobox" id="jzd1" style="width:400px;" value="${entity.dz_jzdzmlpxz}" 
								...
								<td width="30%" class="dialogTd">
										...
										<input type='hidden' name='dz_jzdzxz' id='dz_jzdzxz' value="${entity.dz_jzdzxz}" /> </td>
						</tr>
						<tr class="dialogTr" id="jzdz">
								<td width="20%" class="dialogTd" align="right">户籍地址：</td>
								<td width="50%" class="dialogTd" colspan="2">
										<input class="easyui-combobox" id="hjd1" style="width:400px;" value="${entity.dz_hjdzmlpxz}" 
								...
								<td width="30%" class="dialogTd">
										...
										<input type='hidden' name='dz_hjdzxz' id='dz_hjdzxz' value="${entity.dz_hjdzxz}" /> </td>
						</tr>
						<tr class="dialogTr">
								<td width="20%" class="dialogTd" align="right">工作单位：</td>
								<td width="80%" class="dialogTd" colspan="3" >
									<input type="text" name="dwmc" id="dwmc" class="easyui-combobox" style="width: 613px;" value="${entity.gzdw }"maxlength="100"
											data-options="mode:'remote',method:'post',panelHeight: 22,
											valueField:'id',textField:'text',selectOnNavigation:false,required:false" />
											<input type="hidden" name="gzdw" id="gzdw" value="${entity.gzdw }"/></td>
						</tr>
				</table>
			</div>
		</form>
