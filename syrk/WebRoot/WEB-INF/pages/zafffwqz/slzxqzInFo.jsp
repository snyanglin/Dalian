		...
		<div class="pop_contc">
		 ...
		 <form action="<%=basePath%>fwqz/saveSlzxqzb" id="jbxxForm" name="jbxxForm" method="post">
	    	  ...
	    	  <tr class="dialogTr">
				...
				<input type="text" name="zxqzsj" id="zxqzsj" class="easyui-validatebox " style="width: 200px;" value="${entity.zxqzsj}" readonly
				...
				<td width="30%" class="dialogTd" >
				    <input class="easyui-validatebox" type="text" id="jdr" name="jdr" readonly
	    	  	...
	    	  	<tr class="dialogTr">
	    	  		...
	    	  		<td width="80%" class="dialogTd" align="left" colspan="3">
						<input class="easyui-validatebox" type="text" id="jddw" name="jddw" readonly
				...
				<tr class="dialogTr">
	    	  		<td width="20%" class="dialogTd" align="right">咨询求助内容：</td>
			    	    <td width="80%" class="dialogTd" colspan="3">
			    	    	<textarea id="zxqznr" name="zxqznr" class="easyui-validatebox" rows="3" style="width:100%; height:82px;" readonly
				...
				<tr class="dialogTr">
	    	  		...
	    	  		<td width="20%" class="dialogTd" align="right"> 解答解决方式：</td>
			    	    <td width="80%" class="dialogTd" colspan="3">
			    	    	<textarea id="jdjjfs" name="jdjjfs" class="easyui-validatebox" rows="3" style="width:100%; height:82px;" readonly
