		...
		<div class="pop_contc">
		 ...
		 <form action="<%=basePath%>fwqz/saveZaffxcb" id="jbxxForm" name="jbxxForm" method="post">
	    	  ...
	    	  <tr class="dialogTr">
				...
				<td width="10%" class="dialogTd"><input type="text" name="xcsj" id="xcsj" class="easyui-validatebox " style="width: 200px;" value="${entity.xcsj}"
				...
				<td width="30%" class="dialogTd" >
				    <input class="easyui-validatebox" type="text" id="xcr" name="xcr"
	    	  	...
	    	  	<tr class="dialogTr">
	    	  		...
	    	  		<td width="80%" class="dialogTd" align="left" colspan="3">
						<input class="easyui-validatebox" type="text" id="xcdw" name="xcdw"
				...
				<tr class="dialogTr">
	    	  		...
	    	  		<td width="80%" class="dialogTd" align="left" colspan="3">
						<textarea id="xcxs" name="xcxs" class="easyui-validatebox" rows="3" style="width:100%; height:82px;"
				...
				<tr class="dialogTr">
	    	  		<td width="20%" class="dialogTd" align="right">宣传内容：</td>
			    	    <td width="80%" class="dialogTd" colspan="3">
			    	    	<textarea id="xcnr" name="xcnr" class="easyui-validatebox" rows="3" style="width:100%; height:82px;"
