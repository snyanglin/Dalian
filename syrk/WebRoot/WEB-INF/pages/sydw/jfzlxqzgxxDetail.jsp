			...
			<div data-options="region:'center', split:true" style="width:100%; border-width: 0px;">
				...
				<table border="0" cellpadding="0" cellspacing="6" width="100%" align="center" style="font-size: 26px;">
					...
					<tr class="dialogTr">
						...
						　　根据《辽宁省公共安全技术防范条例》，我局（分局）于&nbsp;&nbsp;${entity.jcrq}&nbsp;&nbsp;
								派员对你（单位）进行了公共安全技术防范监督检查，发现下列违反公共安全技术防范法律行为：
						</td>
					</tr>
					<tr class="dialogTr">
						<td>
						　　<textarea name="wfnr" style="width: 815px;height: 60px;" class="easyui-validatebox">${entity.wfnr}</textarea>
						</td>
					</tr>
					<tr class="dialogTr">
						<td style="line-height: 2em;">
