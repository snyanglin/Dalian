...
<div class="easyui-layout" data-options="fit:true">
    <form action="<%=basePath%>gxxxb/save" id="dataForm" name="dataForm" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
			    ...
			    <tr class="dialogTr">
					...
					<td width="30%" class="dialogTd">
						<input class="easyui-validatebox" type="text" id="gxxs_rs" name="gxxs_rs" style="width:200px;" value="${entity.gxxs_rs }" maxlength="20" 
			    		data-options="required:true,validType:['naturalNumber'],tipPosition:'right'"/>
			    	</td>
					<td width="20%" class="dialogTd" align="right">教师人数：</td>
			    	<td width="30%" class="dialogTd" >
			    		<input class="easyui-validatebox" type="text" name="js_rs" id="js_rs" style="width:200px" value="${entity.js_rs}" maxlength="20" 
			    		data-options="validType:['naturalNumber'],required:true,tipPosition:'left'" /></td>
				</tr>
				<tr class="dialogTr">
					<td width="20%" class="dialogTd" align="right">外籍学生人数：</td>
					<td width="30%" class="dialogTd">
						<input class="easyui-validatebox" type="text" id="wjxs_rs" name="wjxs_rs" style="width:200px;" value="${entity.wjxs_rs }" maxlength="20" 
			    		data-options="required:false,validType:['naturalNumber'],tipPosition:'right'"/>
			    	</td>
					<td width="20%" class="dialogTd" align="right">外籍教师人数：</td>
			    	<td width="30%" class="dialogTd" >
			    		<input class="easyui-validatebox" type="text" name="wjjs_rs" id="wjjs_rs" style="width:200px" value="${entity.wjjs_rs}" maxlength="20" 
				...
				<tr class="dialogTr">
					...
					<td width="30%" class="dialogTd">
						<input class="easyui-validatebox" type="text" id="ssmzxs_rs" name="ssmzxs_rs" style="width:200px;" value="${entity.ssmzxs_rs }" maxlength="20" 
			    		data-options="required:false,validType:['naturalNumber'],tipPosition:'right'"/>
			    	</td>
				</tr>
				<tr class="dialogTr">
					...
					<td width="30%" class="dialogTd">
						<input class="easyui-validatebox" type="text" id="hxsyssl" name="hxsyssl" style="width:200px;" value="${entity.hxsyssl }" maxlength="20" 
			    		data-options="required:false,validType:['naturalNumber'],tipPosition:'right'"/>
			    	</td>
			    ...
			    <tr class="dialogTr">
			    	...
			    	<td width="30%" class="dialogTd">
			    		<input class="easyui-validatebox" type="text" id="glhxwxpzrr" name="glhxwxpzrr" style="width:200px;" value="${entity.glhxwxpzrr }" maxlength="20" 
