...
<div class="easyui-layout" data-options="fit:true">
    <form action="<%=basePath%>dwzybw/save" id="dataForm" name="dataForm" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
		    	...
		    	<tr class="dialogTr">
			    	...
			    	<td width="80%" class="dialogTd" colspan="3">
			    		<input class="easyui-validatebox inputreadonly" type="text" id="dwmc" style="width:618px;" readonly="readonly" />
			    	</td>
			    </tr>
				<tr class="dialogTr">
			    	...
			    	<td width="80%" class="dialogTd" colspan='3'>
				    	...
				    	data-options="required:true,validType:['maxLength[30]'],tipPosition:'left'" type="text" name="zybwmc" id="bwmc" value="${entity.zybwmc}" style="width:618px;" maxlength="30" />
				    </td>
			    </tr>
				<tr class="dialogTr">
				...
				<tr class="dialogTr">
			    	...
			    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="qdsj" id="qdsj" value="${entity.qdsj}"
			    		...
			    		onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})" style="width: 200px;"/>
			    	 </td>
			    </tr>
				<tr class="dialogTr">
			    	<td width="20%" class="dialogTd" align="right">责任人证件种类：</td>
			    	<td width="30%" class="dialogTd">
			    		<input  type="text" name="fzr_cyzjdm"  id="zjlx"  value="${entity.fzr_cyzjdm}" class="easyui-combobox inputreadonly"
			    		style="width: 200px;" data-options="required:false,url: contextPath + '/common/dict/D_BZ_CYZJ.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',onChange:setPassPort,
			    	...
			    	<td width="30%" class="dialogTd">
			    		<input class="easyui-validatebox" type="text" name="fzr_zjhm" id="zjhm" maxlength="30" value="${entity.fzr_zjhm}"
			    		data-options="required:false,tipPosition:'left'"    style="width: 200px;float:left;"/>
				...
				<tr class="dialogTr">
			    	...
			    	<td width="30%" class="dialogTd">
			    		<input  class="easyui-combobox" type="text" name="fzr_xbdm" id="fzrxbdm" 
			    		data-options="required:false,url: contextPath + '/common/dict/D_BZ_XB.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get'" style="width:200px;"/>
			    	</td>
			    </tr>			
			    <tr class="dialogTr">
			    	<td width="20%" class="dialogTd" align="right">责任人联系电话：</td>
			    	<td width="30%" class="dialogTd">
			    		<input class="easyui-validatebox" type="text" name="fzr_lxdh" id="fzrlxdh" maxlength="18"   value="${entity.fzr_lxdh}"
			    		data-options="required:false,validType:['phone','maxLength[18]'],tipPosition:'right'"    style="width: 200px;"/>
			    	</td>
			    	<td width="20%" class="dialogTd" align="right">责任人职务：</td>
			    	<td width="30%" class="dialogTd">
			    		<input class="easyui-validatebox" type="text" name="fzr_zwmc" id="fzrzw" maxlength="20" value="${entity.fzr_zwmc}"
			    		data-options="required:false,validType:['maxLength[20]'],tipPosition:'left'" style="width: 200px;"/>
			    	</td>
			    </tr>			
	    	</table>
	    </div>
	...
	$.ajax({
		...
		success:function(data){
			if (data && data.ryRyjbxxb) {
				$("#fzrxm").val(data.ryRyjbxxb.xm);
				$("#fzrxbdm").combobox("setValue",data.ryRyjbxxb.xbdm);
