...
<body>  
  ...
  <br/><br/>
   ...
   <br>
  	...
  	<br>
  	<input type="button" id="btnDdxxbAdd" value="添加典当业信息" onclick="infoOpen('/ddxxb/addDdxxb','典当业信息',{dwmc:'典当业信息',dwid:'000000'})" />
  	<input type="button" id="btnDdxxbSave" value="修改典当业信息" onclick="infoOpen('/ddxxb/addDdxxb?id=932fc100dede4af2a827094eeb36bbc2','典当业信息',{dwmc:'典当业信息',dwid:'000000'})" />
	<br>
