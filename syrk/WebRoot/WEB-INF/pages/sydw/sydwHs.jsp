  	...
  	<div class="easyui-layout" data-options="fit:true,border:false">   
	    <div data-options="region:'center',split:true,title:'实有单位核实',border:true" style="height:auto">
			<table id="dg" class="easyui-datagrid" 
				data-options="url:'<%=basePath %>sydwcx/queryDwHs',
				delayCountUrl:'<%=basePath %>sydwcx/queryCountSydwHs',
...
function queryButton(){
	...
	dwmc= $.trim(dwmc);
	jyfwzy= $.trim(jyfwzy);
	$('#dg').datagrid('load',{'dwlbdm':dwlbdm,'dwmc':dwmc,'dz_dwdzxz':dz_dwdzxz,'jyfwzy':jyfwzy,'jjlxdm':jyxzdm});
}
//编辑
