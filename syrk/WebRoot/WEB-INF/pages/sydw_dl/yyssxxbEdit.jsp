...
<div class="easyui-layout" data-options="fit:true">
    <form action="<%=basePath%>yyssxxb_dl/save" id="dataForm" name="dataForm" method="post">
	    ...
	    <div data-options="region:'center', split:true" style="width:500px; border-width: 0px;">
		    ...
		    <tr class="dialogTr">
			   ...
			   <td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox "  type="text" id="sbmc" name="sbmc" data-options="required:true,charSet:'halfUpper'"  maxlength="30" style="width:628px;"  value="${entity.sbmc}" /></td>
			</tr>
			<tr class="dialogTr">
		    	<td width="20%" class="dialogTd" align="right">设备用途：</td>
				<td width="80%" class="dialogTd" colspan="3"><textarea class="easyui-validatebox" id="sbyt" name="sbyt" style="width: 628px; height:48px;"
			...
			<tr>
		    	...
		    	<td width="30%" class="dialogTd"><input class='easyui-validatebox' maxlength="20" type='text' name='sbzt' id="sbztdm" value="${entity.sbzt}" style="width:200px;"
			   ...
			   <td width="30%" class="dialogTd"><input class="easyui-validatebox "  type="text" id="sbsl" name="sbsl" data-options="validType:['naturalNumber'],required:false,tipPosition:'left',charSet:'halfUpper'" maxlength="8" style="width:200px;"  value="${entity.sbsl}" /></td>
		  	</tr>
		   	<tr class="dialogTr">
				<td width="20%" class="dialogTd" align="right"> 设备购买日期：</td>
				<td width="30%" class="dialogTd"><input class='easyui-validatebox ' type='text' name='sbgm_rq'  id="sbgm_rq" style="width:200px;" value="${entity.sbgm_rq}" 
			...
			<tr class="dialogTr">
				...
				<td width="80%" class="dialogTd" colspan="3"><textarea class="easyui-validatebox" id="bz" name="bz" style="width: 628px; height:48px;"
