...
<body style="margin-top:20px">
	...
	<form method="post"  action="<%=basePath %>cyrydrrwxxb_dl/save"  enctype="multipart/form-data" style="height: 50px" id="upLoadForm" >
	...
	<table id="dg" class="easyui-datagrid"  
            	data-options="url:'<%=basePath %>cyrydrrwxxb_dl/view?dwid=${dwid}',
            		sortName:'',
            		sortOrder:'desc',
            		idField:'id',
            		pageSize:15,
...
function downLoadTemplate(){
	location.href=contextPath+'/cyrydrrwxxb_dl/exportTemplate';
}
...
function openDetailWindow(rwid){
	location.href=contextPath+'/cyrydrrwmxb_dl/createPage?rwid='+rwid;
}
