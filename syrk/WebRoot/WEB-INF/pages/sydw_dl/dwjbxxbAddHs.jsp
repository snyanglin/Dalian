...
<body style="margin-top:20px" class="bodybg">
	    <div data-options="region:'center', split:true" style="border-width: 0px;margin:0 0 0;text-align:center;" class="bodybg">
	    	  <div data-options="region:'center', split:true" style="width:800px; border-width: 0px;">
    			<form action="<%=basePath%>dwjbxxb_dl/saveDwjbxxbHs" id="jbxxForm" name="jbxxForm" method="post">
    		...
    		<div title="基本信息" id="baseInfoTypeDiv" data-options="selected:true" style="overflow:auto;padding:10px;">   
	    		    ...
	    		    <tr class="dialogTr">
			    	    ...
			    	    <td width="80%" class="dialogTd" colspan="3"><input class="easyui-validatebox" type="text" id="dwjbxxb_dwmc" name="dwjbxxb.dwmc" value="${dwjbxxb.dwmc}" maxlength="50" style="width:595px;" 
		    	 			data-options="required:true,tipPosition:'left'"/></td>
	    	       </tr>
	    		   
	    		   <tr class="dialogTr">
				    	<td width="20%" class="dialogTd" align="right">单位类型：</td>
				    	<td width="30%" class="dialogTd" ><input class="easyui-combobox" type="text" id="dwlbdm" name="dwlbdmValue" value="${dwjbxxb.dwlbdm}" style="width:200px;"
	    	       ...
	    	       <tr class="dialogTr">
					...
					<input class="easyui-combobox" id="jzd1" style="width:400px;" value="${dwjbxxb.dz_dwdzmlpxz}" data-options="required:true,mode:'remote',method:'post',panelHeight: 22,valueField:'id',textField:'text',selectOnNavigation:false">
					...
					<td width="30%" class="dialogTd">
					    	<input class="easyui-combobox" id="jzd2" style="width:200px;" value='${fn:replace(dwjbxxb.dz_dwdzxz, dwjbxxb.dz_dwdzmlpxz, "")}' data-options="required:true,mode:'remote',method:'post',panelHeight: 22,valueField:'id',textField:'text',selectOnNavigation:false">
		    	  ...
		    	  <td width="20%" class="dialogTd" align="right">单位编码：</td>
	    	        ...
	    	        <tr class="dialogTr">
			    	    ...
			    	    <td width="80%" class="dialogTd" colspan="3"><textarea id="dwjbxxb_jyfwzy" name="dwjbxxb.jyfwzy" class="easyui-validatebox" rows="3" style="width:595px; height:52px;"
							data-options="validType:['maxLength[1000]'],invalidMessage:'经营范围（主营）不能超过1000个汉字，请重新输入！',tipPosition:'left'">${dwjbxxb.jyfwzy}</textarea></td>
	    	       </tr>
	    	       ...
	    	       <tr class="dialogTr">
			    	    ...
			    	    <td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" id="dwjbxxb_jymj" name="dwjbxxb.jymj_mjpfm" value="${dwjbxxb.jymj_mjpfm}" style="width:200px;" 
		    	 			data-options="validType:['numeric[\'f\',2]'],invalidMessage:'经营面积为两位小数的数字，请重新输入！',tipPosition:'left'"/></td>
		    	  <td width="20%" class="dialogTd" align="right">重点单位标识：</td>
	    	       ...
	    	       <td width="20%" class="dialogTd" align="right">是否外资单位：</td>
		    	    ...
		    	    <tr class="dialogTr">
				    	...
				    	<td width="30%" class="dialogTd"><input class='easyui-combobox ' type='text'  id="dwjbxxb_gljbdm" name='dwjbxxb.gljbdm' value="${dwjbxxb.gljbdm}" style="width:200px;" 
		    	            data-options="url: contextPath + '/common/dict/D_DW_GLJB.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',tipPosition:'right',onChange:gljbdmOnchange"/></td> 
				    	<td width="20%" class="dialogTd" align="right">管理部门：</td>
				    	<td width="30%" class="dialogTd"><input class='easyui-validatebox inputreadonly'  readonly="readonly" type='text' id="dwjbxxb_glbm" style="width:200px;" 
	    	       ...
	    	       <div title="补充信息" id="otherInfoTypeDiv"  data-options="selected:true" style="overflow:auto;padding:10px;">   
		    	    ...
		    	    <tr class="dialogTr">
			    	    ...
			    	    <td width="80%" class="dialogTd" colspan="3"><textarea id="dwjbxxb_jyfwjy" name="dwjbxxb.jyfwjy" class="easyui-validatebox" rows="3" style="width:595px; height:52px;"
							data-options="validType:['maxLength[1000]'],invalidMessage:'经营范围（兼营）不能超过1000个汉字，请重新输入！',tipPosition:'left'">${dwjbxxb.jyfwjy}</textarea></td>
	    	       </tr>
	    	         <tr class="dialogTr">
		    	   ...
		    	   <td width="20%" class="dialogTd" align="right">经营类型：</td>
			    	    <td width="30%" class="dialogTd"><input class='easyui-combobox' type='text' id='dwjbxxb_jyxzdm' name='dwjbxxb.jjlxdm' value="${dwjbxxb.jjlxdm}" style="width:200px;"
			    	        data-options="url: contextPath + '/common/dict/D_DW_JYXZDM.js',valueField:'id',textField:'text',selectOnNavigation:false,required:false,method:'get'"/></td>
		    	   ...
		    	   <tr class="dialogTr">
			    	    ...
			    	    <td width="30%" class="dialogTd"><input class='easyui-combobox' type='text' id='dwjbxxb_sfyxfjddm' name='dwjbxxb.sfyxfjddm' value="${dwjbxxb.sfyxfjddm}" style="width:200px;"
			    	        data-options="url: contextPath + '/common/dict/D_BZ_SF.js',valueField:'id',textField:'text',selectOnNavigation:false,required:false,method:'get',onChange:sfyfwjddmOnchange"/></td>
		    	    ...
		    	    <tr class="dialogTr">
		    	     ...
		    	     <tr class="dialogTr">
			    	    ...
			    	    <td width="80%" class="dialogTd" colspan="3"><textarea id="dwjbxxb_zqxyygl"    name="dwjbxxb.zqxyygl" class="easyui-validatebox" rows="3" style="width:595px; height:52px;"
	    		   ...
	    		   <tr class="dialogTr">
			    	    ...
			    	    <td width="80%" class="dialogTd" colspan="3"><textarea id="dwjbxxb_bz" name="dwjbxxb.bz" class="easyui-validatebox" rows="3" style="width:595px; height:52px;"
...
$(document).ready(function(){
	initAddressSearch('jzd1', {zrqdm:zrqdm}, 'dz_dwdzmlpdm', 'dz_dwdzmlpxz', 'jzd2', {text:'dz_dwdzxz',dzxzqh:'dz_dwdzssxdm',id:'dz_dwdzdm'}, null, null);
	$('#dwjbxxb_dwztdm').combobox('setValue','10');
	$('#dwjbxxb_sfzqxyydm').combobox('setValue','1');
	setInputReadonly('dwlbdm', true);
	setInputReadonly('dwjbxxb_gljbdm', true);
	setInputReadonly('ryjbxxb_dwbh', true);
	...
	$("#lxrdg").datagrid({
		url:"<%=basePath %>dwfrfzrllyxxb_dl/list",
		title:"法人\负责人\联络员",
		border:false,
		sortOrder:"desc",
		sortName:"xt_zhxgsj",
		...
		columns:[[
			...
			{field:"cyzjdm",title:"证件类型",align:'center',width:120,formatter:dictFormatter,dictName:contextPath+'/common/dict/D_BZ_CYZJ.js'},
			{field:"zjhm",title:"证件号码",align:'center',width:120},
			{field:"xm",title:"姓名",align:'center',width:100},
			{field:"sfzgsrzdm",title:"是否在公司任职",align:'center',width:120,formatter:dictFormatter,dictName:contextPath+'/common/dict/D_BZ_SF.js'},
			{field:"zw",title:"职务",align:'center',width:90},
	...
	$("#cyrydg").datagrid({
		...
		idField:"id",
		columns:[[
			{field:"cyzjdm",title:"证件类型",align:'center',width:80,formatter:dictFormatter,dictName:contextPath+'/common/dict/D_BZ_CYZJ.js'},
			{field:"zjhm",title:"证件号码",align:'center',width:120},
...
function cyryEdit(linkObject, index) {
	...
	var editUrl = contextPath + '/cyryxxb_dl/createPage';
...
function lxrEdit(linkObject, index) {
	cancelBubble(); // 阻止冒泡，不然要执行onClickRow
	var editUrl = contextPath + '/dwfrfzrllyxxb_dl/createPage';
...
function lxrCancel(linkObject, index) {
	cancelBubble(); // 阻止冒泡，不然要执行onClickRow
	var deleteUrl = contextPath + '/dwfrfzrllyxxb_dl/delete';
	var submitFields = ""; //  除主键之外需要提交的字段（多个用逗号分隔）
	topMessager.confirm('','您确认要注销数据吗？',function(r) {  
		if (r) {	
			var opts = $("#lxrdg").datagrid("options");
...
function save_onclick(bottonObject, hslx,anlx) {
			...
			if (r) {
				...
				formObject.form('submit',{
					...
					success: function(result) {
						...
						var id =$("#dwjbxxb_id").val();
						if (result.status == 'success') {
							 // 返回成功后执行的方法
						if ($('#nextDwid').val() != "") {
							
						var openUrl = contextPath + "/dwjbxxb_dl/createHs";
