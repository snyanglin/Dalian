...
<div class="easyui-layout" data-options="fit:true">
    <form action="<%=basePath%>dwyhflcxxb_dl/save" id="dataForm" name="dataForm" method="post">
	    ...
	    <div data-options="region:'center', split:true" style="width:100%; border-width: 0px;">
			...
			<tr class="dialogTr">
		    	...
		    	<td width="75%" class="dialogTd" colspan='3'><input class="easyui-validatebox" type="text" name="flcmc" id="flcmc" maxlength="50"
			...
			<tr class="dialogTr">
				<td width="20%" class="dialogTd" align="right">负责人证件类型：</td>
		    	<td width="30%" class="dialogTd" ><input class="easyui-combobox" type="text" name="fzrcyzjdm" id="fzrcyzjdm"
		    	...
		    	<td width="30%" class="dialogTd" ><input class="easyui-validatebox" type="text" name="fzrzjhm" id="fzrzjhm"
					data-options="required:false,validType:['maxLength[30]'],tipPosition:'left'" value="${entity.fzrzjhm}" maxlength="30"
		    	 style="width:200px;float:left;"
		    	 /><div class="lodingimg" id="jjlxrDiv" ></div></td>
		    </tr>	
		    <tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd" ><input class="easyui-validatebox" type="text" name="fzr" id="fzr"
		    	data-options="required:false,validType:['maxLength[20]'],tipPosition:'left'" value="${entity.fzr}" maxlength="20"
		    	 style="width:200px"
		    	 /></td>
		    </tr>	
			...
			<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd" ><input class="easyui-validatebox" type="text" name="fzrlxdh" id="fzrlxdh" maxlength="18"
		    	...
		    	<td width="30%" class="dialogTd" ><input class="easyui-validatebox" type="text" name="fzrzw" id="fzrzw"
