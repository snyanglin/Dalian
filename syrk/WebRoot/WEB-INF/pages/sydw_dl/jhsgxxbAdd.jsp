...
<div class="easyui-layout" data-options="fit:true">
    <form action="<%=basePath%>jhsgxxb_dl/save" id="dataForm" name="dataForm" method="post">
	    ...
	    <div data-options="region:'center', split:true" style="width:500px; border-width: 0px;">
			...
			<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox inputreadonly" type="text" id="dwmc" style="width:600px;" readonly="readonly" /></td>
		    </tr>
		    <tr class="dialogTr">
				<td width="20%" class="dialogTd" align="right">申请报告号：</td>
				<td width="80%" class="dialogTd"><input  type='text' id='sqbgh' name='sqbgh' class="easyui-validatebox" style="width:600px;"
			 ...
			 <tr class="dialogTr">
				...
				<td width="80%" class="dialogTd"><input  type='text' id='zxzm' name='zxzm' class="easyui-validatebox" style="width:600px;"
			 ...
			 <tr class="dialogTr">
				...
				<td width="80%" class="dialogTd"><input  type='text' id='jycssyzm' name='jycssyzm'  class="easyui-validatebox"style="width:600px;"
