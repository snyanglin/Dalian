...
<div class="easyui-layout" data-options="fit:true">
    <form action="<%=basePath%>ddxxb_dl/saveDdxxb" id="dataForm" name="dataForm" method="post">
	    ...
	    <div data-options="region:'center', split:true" style="width:500px; border-width: 0px;">
			...
			<tr class="dialogTr">
				...
				<td width="20%" class="dialogTd" align="right">设立申请书：</td>
		    	<td width="30%" class="dialogTd">
	    	...
	    	<tr class="dialogTr">
				...
				<td width="80%" class="dialogTd" colspan="3">
				<input class="easyui-combobox" type="text" id="dd_jzwjglxdm" name="dd_jzwjglxdm" style="width:627px;" value="${entity.dd_jzwjglxdm}"
