...
<table >
				...
				<table cellpadding="0" cellspacing="0" class="nameTable" >
					<tr>
						<th  align="right" width="130">管理类型：</th>
							...
							<c:forEach items="${zdrylx }" var="lx" >
								<script type="text/javascript">document.write(window.top.getDictName(contextPath + '/common/dict/BD_D_ZDRYLBDM.js', "${lx}"));</script>&nbsp;&nbsp;
							</c:forEach></td>
					</tr>
					<tr>
	...
	<input type="hidden" id="serverPara" value="ryid=${zdry.ryid}&syrkid=${zdry.syrkid}" /><!-- 业务办理附加参数  -->
...
var infoPara = {
		mainUrl:"/zdry/queryRyzsxx",
		mainPara:"zdrylxJson="+zdrylxJson,
		queryUrl:"/zdry/service/",
		queryPara:$("#queryPara").val(),
		serverMenuUrl:"/zdry/queryYwglgn",
		...
		del_childInfo:"/zdry/delete_xxzsnrb"
	};
