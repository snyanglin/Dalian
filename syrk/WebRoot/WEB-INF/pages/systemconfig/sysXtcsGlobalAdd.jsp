    ...
    <form action="<%=basePath%>sysXtcsGlobal/save" id="dataForm" name="dataForm" method="post">
	    <div data-options="region:'center', split:true" style="width:500px; border-width: 0px;">
	    	...
	    	<tr class="dialogTr">
		    	...
		    	<td width="30%" class="dialogTd"><input class="easyui-validatebox" type="text" name="csmc" style="width:200px;" maxlength="40" data-options="required:true,validType:['variable'],invalidMessage:'参数名称必须为合法的变量名称，请重新输入！'"/></td>
