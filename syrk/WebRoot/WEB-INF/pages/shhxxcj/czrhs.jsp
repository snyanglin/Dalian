...
<div data-options="region:'center',split:true" style="border-width: 0px;margin:0 0 0;text-align:center;" class="bodybg">
	...
	<tr><td height="100%" valign="top" align="center">
		...
		<div data-options="region:'center', split:true" style="width:800px; border-width: 0px;">
		 <form action="<%=basePath%>shhxxcj/saveCzrhs" id="dataForm" name="dataForm" enctype="multipart/form-data" method="post">
				
				
		    	<input type="hidden" id="czfwid" name="czfwid" value="${entity.czfwid}" />
		    	<input type="hidden" id="id" name="id" value="${entity.id}" />
		        <input type="hidden" id="czrId" name="czrId" value="${czrId}" />
		...
		<%--     	 <tr class="dialogTr">
			    ...
			    <td width="80%" colspan="3" class="dialogTd"><input class="easyui-validatebox inputreadonly" type="text" id="hjd_dzms" name="hjd_dzms"  style="width:626px;"  value="${entity.hjd_dzms}"  />
				</td>
			    </tr> --%>
