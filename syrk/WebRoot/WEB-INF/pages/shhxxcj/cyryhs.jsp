...
<body>
    ...
    <form action="<%=basePath%>shhxxcj/saveCyryhs" id="jbxxForm" name="jbxxForm" method="post" onsubmit="alert('ssss')">
    	...
    	<input type="hidden" name="emEmployeeId" id="emEmployeeId" value="${emEmployeeId }" />
    	...
    	<div class="easyui-accordion" data-options="multiple:true" style="width:820px;margin-left: 20px;margin-top: 10px;margin-right: 5px;margin-bottom: 10px;"> 
    		...
    		<table border="0" cellpadding="0" cellspacing="10" style="width: 100%;" align="center">
			    ...
			    <tr class="dialogTr">
		    	   ...
		    	   <td width="30%" class="dialogTd"><input type="text" name="zylbdm" id="zylbdm" class="easyui-combotree" style="width:200px;" value="${entity.whcddm }"
		    			data-options="url: contextPath + '/common/dict/D_BZ_ZYFLYDM.js',onlyLeaf:true,dataFilter:'',multiple:false,required:true,panelWidth:200,method:'get',
		    			editable:true,lines:true,tipPosition:'right'">
					</td>
