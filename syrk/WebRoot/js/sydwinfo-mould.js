...
function info_gwxxb_(){
	...
	sb.append("<li><span class='spantitle'>安全出口数量(个)：</span><span name='cksl' class='edit_word input_w2'></span></li>");
	...
	sb.append("<li><span class='spantitle'>是否有安检设备：</span><span name='sfyajsb' dict='/common/dict/D_GG_YW' class='edit_word input_w1'></span></li>");
...
function info_amxxb_(){
	...
	sb.append("<li><span class='spantitleb'>按摩间数(间)：</span><span name='amrsl'  class='edit_word input_w2b'></span></li>");
//	sb.append("<li><span class='spantitleb'>按摩床(椅)数量：</span><span name='amcsl' class='edit_word input_w2b'></span></li>");
	sb.append("<li><span class='spantitleb'>按摩师数量(人)：</span><span name='amssl' class='edit_word input_w2b'></span></li>");
	sb.append("<li><span class='spantitleb'>安全出口数量(个)：</span><span name='cksl' class='edit_word input_w2b'></span></li>");
	sb.append("<li><span class='spantitleb'>休闲大厅面积(平方米)：</span><span name='xxdtmj' class='edit_word input_w2b'></span></li>");
	sb.append("<li><span class='spantitleb'>是否具有住宿许可：</span><span name='sfjyzxxk' dict='/common/dict/D_GG_YW' class='edit_word input_w2b'></span></li>");
