...
HomePcs.queryXjZzjg = function(){
	...
	if(HomePcs.orgcodes!=''){
		...
		var fajax =new FrameTools.Ajax(contextPath+"/homePage/queryXjZzjgxj",HomePcs.queryXjZzjg_back);
		fajax.send(params);
	}
};
/**
...
HomePage.syrkListMBR = function(lx){
	...
	$(document.getElementById("tdmapid")).mask("数据加载中...");
	var params = {lx:lx,zzjgdm:HomePcs.zzjgdm};
	var fajax =new FrameTools.Ajax(contextPath+"/homePage/querySyrkList",HomePage.syrkListMBR_back);
	fajax.send(params);
};
/**
