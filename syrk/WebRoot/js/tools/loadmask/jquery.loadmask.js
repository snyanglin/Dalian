...
;(function($){
	...
	$.maskElement = function(element, label){
		...
		maskDiv.height(h + parseInt(element.css("padding-top")) + parseInt(element.css("padding-bottom")));
		maskDiv.width(w + parseInt(element.css("padding-left")) + parseInt(element.css("padding-right")));
