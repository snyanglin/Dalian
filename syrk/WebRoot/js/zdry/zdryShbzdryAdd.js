...
$(document).ready(function(){
	...
	initAddressSearch("jzd1", {zrqdm:'#zrqdm'}, "dz_jzdzmlpdm", "dz_jzdzmlpxz", "jzd2", {text:"dz_jzdzxz",dzxzqh:"dz_jzdzssxdm",id:"dz_jzdzdm"}, null, null);
});
...
//				}
				...
				$("#hjd_pcsdm").val(data.ryRyjbxxb.hjd_pcsdm);
