 ...
 */
@Controller
@RequestMapping("zdryXdryxdxx")
public class ZdryXdryxdxxControl extends BaseController {

	private Logger logger = Logger.getLogger(this.getClass());

	@Resource(name = "zdryXdryService")
	private ZdryXdryService zdryXdryService;
	...
	public ModelAndView add(String zdryid) {
		...
		ModelAndView mv = new ModelAndView("zdry/zdryXdryxdxx");
		ZdryXdryxxb entity = new ZdryXdryxxb();
	...
	public ModelAndView save(ZdryXdryxxb entity, SessionBean sessionBean) {
		ModelAndView mv = new ModelAndView(getViewName(sessionBean));
		Map<String, Object> map = new HashMap<String, Object>();
		sessionBean = getSessionBean(sessionBean);
		try {
			zdryXdryService.save(entity, sessionBean);
	...
	public ModelAndView edit(@PathVariable(value = "id") String id,
		...
		ModelAndView mv = new ModelAndView("zdry/zdryXdryxdxx");
		ZdryXdryxxb entity = zdryXdryService.queryById(id);
		if (entity == null) {
	...
	public ModelAndView update(ZdryXdryxxb entity, SessionBean sessionBean) {
		ModelAndView mv = new ModelAndView(getViewName(sessionBean));
		Map<String, Object> map = new HashMap<String, Object>();
		sessionBean = getSessionBean(sessionBean);
		try {
			zdryXdryService.update(entity, sessionBean);
			map.put(AppConst.STATUS, AppConst.SUCCESS);
