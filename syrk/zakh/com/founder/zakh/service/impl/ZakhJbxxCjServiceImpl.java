...
public class ZakhJbxxCjServiceImpl implements ZakhJbxxCjService {
	...
	@Override
	public void bckhfstjByOrgCode(String dateString, String orgCode) {
	

		OrgOrganization org=this.orgOrganizationService.queryByOrgcode(orgCode);
		...
		try {
			...
			if (week == week1225 && week1225 == week1226) {
				...
				if(org.getOrglevel().equals("50")){
					this.createDataByOrg(year, week, startDate1, endDate1, org, "zrq");
					this.createDataByOrg(year, week, startDate2, endDate2, org, "zrq");


				}else if(org.getOrglevel().equals("32")){
					this.createDataByOrg(year, week, startDate1, endDate1, org, "pcs");
					this.createDataByOrg(year, week, startDate2, endDate2, org, "pcs");


				}else if(org.getOrglevel().equals("21")){
					this.createDataByOrg(year, week, startDate1, endDate1, org, "fj");
					this.createDataByOrg(year, week, startDate2, endDate2, org, "fj");
				...
				if(org.getOrglevel().equals("50")){
					this.createDataByOrg(year, week, startDate, endDate, org, "zrq");


				}else if(org.getOrglevel().equals("32")){
					this.createDataByOrg(year, week, startDate, endDate, org, "pcs");


				}else if(org.getOrglevel().equals("21")){
					this.createDataByOrg(year, week, startDate, endDate, org, "fj");
	...
	private void createDataByOrg(int tjYear, int tjWeek, Date startDate,
			Date endDate, OrgOrganization org, String zzjgdj) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
