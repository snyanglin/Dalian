...
public class SydwEditController extends BaseController {
	...
	public ModelAndView view(@RequestParam(value = "id") String id,@RequestParam(value = "mode",required=false,defaultValue="") String mode,String messageid)	throws BussinessException {
		...
		ModelAndView mv = new ModelAndView("sydw_dl/sydwEdit");
	...
	public ModelAndView cyryxxb_query_more(String dwid,String mode){
		ModelAndView mv = new ModelAndView("sydw_dl/cyryxxbDetail");
	...
	public void cyryxxb_query_all_export(String dwid, HttpServletResponse response){
		...
		try {
			...
			String[] titleArray = {"聘用时间","身份证号码","姓名 ","性别","出生日期","居住地详址"};
			String[] keyArray = {"pyrq","zjhm","xm","xbdm","csrq","dz_xzzxz"};
