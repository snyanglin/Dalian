...
/******************************************************************************
 * @Package:      [com.founder.sydw_dl.controller.CyrydrrwmxbComtroller.java]  
 ...
 */
@Controller
@RequestMapping(value = "cyrydrrwmxb_dl")
public class CyrydrrwmxbController extends BaseController {
	...
	ModelAndView createPage(String rwid) {
		ModelAndView mv = new ModelAndView("sydw_dl/cyrydrrwmxbDetail");
	...
	public void cyryxxb_query_all_export(String rwid, HttpServletResponse response){
		...
		try {
			...
			String[] titleArray = {"聘用时间","身份证号码","姓名 ","性别","出生日期","居住地详址","导入结果","描述"};
			String[] keyArray = {"pysj","zjhm","xm","xbdm","csrq","dz_xzzxz","drjg","mxms"};
