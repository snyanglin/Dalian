...
@DBInfoAnnotation(tableName = "JCJ_CWRZB", pk = "id")
public class JcjCwrzb extends BaseEntity implements Serializable{
	...
	public String getSfcxcw() {
		return sfcxcw;
	}
	public void setSfcxcw(String sfcxcw) {
		this.sfcxcw = sfcxcw;
	}
	public String getBz() {
		return bz;
