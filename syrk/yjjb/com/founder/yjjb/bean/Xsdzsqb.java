 ...
 * @version 1.0
 */
@DBInfoAnnotation(tableName = "YJJB_XSDZSQB", pk = "id")
	public class Xsdzsqb extends BaseEntity  {
	...
	@FieldDesc("递转发起单位") 
	private String dzfqdw;
	
	@FieldDesc("递转接收单位") 
	private String dzjsdw;
	...
	public String getDzfqdw() {
		return dzfqdw;
	}
	
	public void setDzfqdw(String dzfqdw) {
		this.dzfqdw = dzfqdw;
	}
	
	public String getDzjsdw() {
		return dzjsdw;
	}
	
	public void setDzjsdw(String dzjsdw) {
		this.dzjsdw = dzjsdw;
	}
