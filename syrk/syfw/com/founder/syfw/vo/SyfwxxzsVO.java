 ...
 *
 */
public class SyfwxxzsVO implements Serializable{
	...
	private List<SyfwxxzsVO> list = new ArrayList<SyfwxxzsVO>();
	...
	public List<SyfwxxzsVO> getList() {
		return list;
	}

	public void setList(List<SyfwxxzsVO> list) {
		this.list = list;
	}
}
