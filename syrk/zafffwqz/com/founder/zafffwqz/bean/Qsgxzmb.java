...
@DBInfoAnnotation(tableName = "FWQZ_QSGXZMB", pk = "id")
public class Qsgxzmb extends BaseEntity implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	@FieldDesc("亲属关系证明ID")private String id;
	@FieldDesc("证明接收单位")private String zmjsdw;
	...
	@FieldDesc("开具日期")private String kjrq;
	@FieldDesc("证明开具单位ID")private String zmkjdwid;
	@FieldDesc("证明开具单位")private String zmkjdw;
	@FieldDesc("证明开具人ID")private String zmkjrid;
	@FieldDesc("证明开具人")private String zmkjr;
