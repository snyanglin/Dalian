...
@DBInfoAnnotation(tableName = "FWQZ_JZZMB", pk = "id")
public class Jzzmb extends BaseEntity implements Serializable{
	...
	public String getSyrkdjpcs() {
		return syrkdjpcs;
	}
	public void setSyrkdjpcs(String syrkdjpcs) {
		this.syrkdjpcs = syrkdjpcs;
	}
