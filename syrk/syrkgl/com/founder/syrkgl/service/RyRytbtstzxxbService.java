...
/**
 * ****************************************************************************
 * @Package:      [com.founder.syrkgl.service.RyRytbtstzxxbService.java]  
 * @ClassName:    [RyRytbtstzxxbService]   
 * @Description:  [实有人口附加信息-人员体表特殊特征信息表]   
 * @Author:       [xu_wenjun@founder.com.cn]  
 * @CreateDate:   [2015-4-12 下午10:36:48]   
 * @UpdateUser:   [Administrator(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-4-12 下午10:36:48，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0]
 */
@TypeAnnotation("实有人口附加信息-人员体表特殊特征信息表")
public interface RyRytbtstzxxbService {
