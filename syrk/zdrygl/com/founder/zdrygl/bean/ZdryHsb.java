 ...
 * ****************************************************************************
 * 
 * @Package: [com.founder.zdrygl.bean.ZdryHsb.java]
 * @ClassName: [ZdryHsb]
 * @Description: []
...
public class ZdryHsb extends BaseEntity implements Serializable {
	...
	@FieldDesc("列管_申请人")
	private String lg_sqr;
	@FieldDesc("列管_申请人ID")
	private String lg_sqrid;
	@FieldDesc("列管_申请日期")
	private String lg_sqrq;
	@FieldDesc("列管_审批人")
	private String lg_spr;
	@FieldDesc("列管_审批人ID")
	private String lg_sprid;
	@FieldDesc("列管_审批日期")
	private String lg_sprq;
	@FieldDesc("列管_审批意见")
	private String lg_spyj;
	@FieldDesc("监管对象_监管类别代码")
	private String jgdx_jglbdm;
	@FieldDesc("监管对象_监管单位机构代码")
	private String jgdx_jgdwjgdm;
	@FieldDesc("监管对象_监管单位名称")
	private String jgdx_jgdwmc;
	@FieldDesc("监管对象_判决机关名称")
	private String jgdx_pjjgmc;
	@FieldDesc("重点人口_管理方法代码")
	private String zdrk_glffdm;
	@FieldDesc("重点人口_列管来源代码")
	private String zdrk_lglydm;
