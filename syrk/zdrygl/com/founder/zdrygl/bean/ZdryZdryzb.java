...
public class ZdryZdryzb  extends BaseEntity implements Serializable {
	...
	@FieldDesc("籍贯省市县（区）代码") private String jgssxdm;
	@FieldDesc("户籍地所属县级公安机关代码") private String hjd_ssxjgajgdm;
	@FieldDesc("户籍地所属派出所代码") private String hjd_sspcsdm;
	@FieldDesc("户籍地所属社区") private String hjd_sssq;
	@FieldDesc("居住地所在地市代码") private String jzd_szdsdm;
	public String getId() {
		return id;
	}
