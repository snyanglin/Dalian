...
/**
 * ****************************************************************************
 * @Package:      [com.founder.zdrygl.bean.Zdrylxylbdyb.java]  
 * @ClassName:    [Zdrylxylbdyb]   
 * @Description:  [重点人员类型与类别对应表]   
 * @Author:       [zhang.hai@founder.com.cn]  
 * @CreateDate:   [2015年8月6日 下午2:44:14]   
 * @UpdateUser:   [ZhangHai(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015年8月6日 下午2:44:14，(如多次修改保留历史记录，增加修改记录)]   
...
public class Zdrylxylbdyb extends BaseEntity implements Serializable {
	...
	@FieldDesc("上级类别代码") private String lbdm_p;
	@FieldDesc("分组，用于区分存什么表") private String fz;
