...
/******************************************************************************
 * @Package:      [com.founder.zdrygl.bean.ZdrySqsbzdryxxb.java]  
...
public class ZdrySqsbzdryxxb extends BaseEntity implements Serializable ,Zdry{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1216284034254766742L;
	@FieldDesc("重点人员ID")
	private String id;
	@FieldDesc("管理方法代码")
