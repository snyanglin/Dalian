...
public class ZdryFactory implements ZdryAbstractFactory {
	...
	public ZdryService createZdryService(String zdrylx, Zdry zdryzb, Zdry zdrylbdx) {
		...
		ZdryService zdryzbService = createZdryzbService(getBeanName(ZDRYZB));
		...
		if(!StringUtils.isEmpty(className)){
			...
			registerBeanDefinition(beanName,className,zdryzbService,false); 
	...
	private void registerBeanDefinition(String beanName,String className,Object constructorArgValue,boolean reRegister){
