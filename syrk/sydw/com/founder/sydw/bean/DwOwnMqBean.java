...
/******************************************************************************
 * @Package:      [com.founder.sydw.bean.DwOwnMqBean.java]  
 * @ClassName:    [DwOwnMqBean]   
 * @Description:  [一句话描述该类的功能]   
 * @Author:       [star]  
 * @CreateDate:   [2015-6-5 下午1:49:02]   
 * @UpdateUser:   [star(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-6-5 下午1:49:02，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0] 
 */
@DBInfoAnnotation(tableName = "DW_DWMQXXB", pk = "id")
public class DwOwnMqBean extends BaseEntity implements Serializable {
	...
	public String getCkqk() {
		return ckqk;
	}
	public void setCkqk(String ckqk) {
		this.ckqk = ckqk;
	}
