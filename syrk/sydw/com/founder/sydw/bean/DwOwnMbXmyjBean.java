...
/******************************************************************************
 * @Package:      [com.founder.sydw.bean.DwOwnMbXmyjBean.java]  
 * @ClassName:    [DwOwnMbXmyjBean]   
 * @Description:  [一句话描述该类的功能]   
 * @Author:       [star]  
 * @CreateDate:   [2015-6-5 下午1:48:06]   
 * @UpdateUser:   [star(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-6-5 下午1:48:06，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0] 
 */
@DBInfoAnnotation(tableName = "DW_DWXMYJB", pk = "id")
public class DwOwnMbXmyjBean extends BaseEntity implements Serializable {
	...
	private String xmmc;
	@FieldDesc("爆破施工日期")
	private String bpsgrq;
	@FieldDesc("第一设计人")
	private String dysjr;
	@FieldDesc("采集时间")
	...
	public String getBpsgrq() {
		return bpsgrq;
	}
	public void setBpsgrq(String bpsgrq) {
		this.bpsgrq = bpsgrq;
	}
	public String getDysjr() {
		return dysjr;
	}
	...
	public void setDysjr(String dysjr) {
		this.dysjr = dysjr;
	}
