...
/******************************************************************************
 * @Package:      [com.founder.sydw.bean.DwOwnYxyycsBean.java]  
 * @ClassName:    [DwOwnYxyycsBean]   
 * @Description:  [一句话描述该类的功能]   
 * @Author:       [star]  
 * @CreateDate:   [2015-6-5 下午1:55:32]   
 * @UpdateUser:   [star(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-6-5 下午1:55:32，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0] 
 */
@DBInfoAnnotation(tableName = "DW_DWYYXXB", pk = "id")
public class DwOwnYxyycsBean extends BaseEntity implements Serializable {
	...
	private String id;
	@FieldDesc("游戏游艺机数")
	private String yxyyjs;
	@FieldDesc("出口数量 ")
	private String cksl;
	@FieldDesc("游戏游艺机机型")
	private String yxyyjlx;
	@FieldDesc("单位ID")
	private String dwid;
	@FieldDesc("采集时间")
	...
	public void setYxyyjlx(String yxyyjlx) {
		this.yxyyjlx = yxyyjlx;
	}
	public String getYxyyjs() {
		return yxyyjs;
	}
	public void setYxyyjs(String yxyyjs) {
		this.yxyyjs = yxyyjs;
	}
