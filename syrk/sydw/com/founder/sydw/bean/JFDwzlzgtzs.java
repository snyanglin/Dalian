...
/**
 * ****************************************************************************
 * @Package:      [com.founder.sydw.bean.JFDwzlzgtzs.java]  
 * @ClassName:    [JFDwzlzgtzs]   
 * @Description:  技防责令整改通知书
 ...
 * @Version:      [v1.0]
 */
@DBInfoAnnotation(tableName = "DW_JFZLZGTZS", pk = "id")
public class JFDwzlzgtzs extends BaseEntity implements Serializable {
