...
public class ZzyhjzzsbbController  extends BaseController {
	...
	public ModelAndView add(String id,String dwid){
		ModelAndView mv = new ModelAndView("sydw/zzyhjzzsbbAdd");
	...
	@RequestMapping(value = "/zzyhjzzsbb_query", method = RequestMethod.POST)
	@ResponseBody
	public List<Zzyhjzzsbb> zzyhjzzsbb_query(String dwid){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("dwid", dwid);
		return zzyhjzzsbbService.zzyhjzzsbb_query(map);
	}
}
