...
/******************************************************************************
 * @Package:      [com.founder.sydw.service.impl.CyrydrrwxxbService.java]  
...
public  class CyrydrrwxxbServiceImpl  extends BaseService implements CyrydrrwxxbService {
	 ...
	 * @param map
	 * @return
	 * @see com.founder.sydw.service.CyrydrrwxxbService#queryById(java.util.Map)
	 */
	@Override
	 ...
	 * <p>Description: </p>
	 * @param entity
	 * @see com.founder.sydw.service.CyrydrrwxxbService#saveEntity(com.founder.sydw.bean.Cyrydrrwxxb)
	 */
	@Override
	...
	public void importToCyry(InputStream in,SessionBean sessionBean,String rwid,String fileType){
		try{
			...
			for (int i = 0; i < sheet.getPhysicalNumberOfRows(); i++) {
				...
				// 身份证复用信息
				RyRyjbxxb ryjbxxb =ryRyjbxxbService.queryByCyzjdmZjhm("111",sfz);// 111为身份证类型
			...
			message.setXxlb("5");
			message.setYwurl("/cyrydrrwmxb/createPage?rwid="+cyrydrrwxxb.getId());
