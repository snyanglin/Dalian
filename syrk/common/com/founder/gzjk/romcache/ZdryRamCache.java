...
public class ZdryRamCache {
	...
	public void init2(Map<String,String[]> map){
		gzjkMapContList = gzjkDao.queryZdryOrgAll();
		zzjgList = map;
		/*for(String key: gzjkMapContList.keySet()){
			gzjkDao.insertZdryTop20(key);
	...
	public void addGzjkList(String ryid, String type,String orgcode) {
		...
		GzjkTemp gzjkTemp = gzjkDao.queryGzjkZdryByRyid(ryid,orgcodeValue,level);
		if(gzjkTemp != null){
