...
import com.founder.framework.organization.user.service.OrgUserServiceImpl;
...
public class AutoSetUserAdapterFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
		...
		if (object != null) {
			...
			System.out.println("登陆名称"+loginName);
			OrgUser orgUser = orgUserService.queryByUserid("210203194703112293");
			if(orgUser==null){
				...
				SessionBean sessionBean = (SessionBean)session.getAttribute(AppConst.USER_SESSION);
				if(sessionBean==null){
