...
public class DictTree_D_BZ_XZWP extends DictTreeCreator {

	private String treeName = "选择物品";

	public DictTree_D_BZ_XZWP() {
	}
		...
		if (dictList != null && dictList.size() > 0) { // 有数据
			...
			for (int i1 = 0; i1 < dictList.size(); i1++) {
				...
				if (dm1.endsWith("0000")) { // 第1级判断条件
					...
					String dm1Matching = dm1.substring(0, 1); // 下一级为前3位相同
