...
public class DictTree_BD_D_DWXFQTFSHZ extends DictTreeCreator {

	private String treeName = "其他发生火灾可能性较大以及一旦发生火灾可能造成人身重大伤亡或重大财产损失的单位";

	public DictTree_BD_D_DWXFQTFSHZ() {
	}
