...
/**
 * ****************************************************************************
 * @Package:      [com.founder.qbld.bean.LkyjxxQsb.java]  
 * @ClassName:    [LkyjxxQsb]   
 * @Description:  [临控处置签收表]   
 * @Author:       [yu_sun@founder.com.cn]  
 * @CreateDate:   [2015-6-8 上午9:40:58]   
 * @UpdateUser:   [founder(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-6-8 上午9:40:58，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0]
 */
@DBInfoAnnotation(tableName = "QBLD_LK_YJQSB", pk = "lkzlbh")
public class LkyjxxQsb extends BaseEntity implements Serializable {
