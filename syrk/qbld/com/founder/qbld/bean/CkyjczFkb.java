...
/**
 * ****************************************************************************
 * @Package:      [com.founder.qbld.bean.CkyjczFkb.java]  
 * @ClassName:    [CkyjczFkb]   
 * @Description:  [常控预警反馈信息表]   
 * @Author:       [yu_sun@founder.com.cn]  
 * @CreateDate:   [2015-6-8 上午9:39:55]   
 * @UpdateUser:   [founder(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-6-8 上午9:39:55，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0]
 */
@DBInfoAnnotation(tableName = "QBLD_CK_YJCZFKB", pk = "czfkxxbh")
public class CkyjczFkb extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 1L;

	@FieldDesc("所反馈的重点人员常控预警情报信息编号")
	...
	@FieldDesc("采用GA XXX.2中的重点人员预警处置措施类型代码采用GA XXX.2中的重点人员管控措施代码")
	private String gkcs;
	...
	@FieldDesc("省级预警级别 所反馈的重点人员常控预警情报信息在省级情报平台发出或自上级重点人员常控预警信息转发时的预警级别，采用GA xxx.2中的“重点人员常控预警级别代码”")
	private String sjyjjb;
	@FieldDesc("处置措施细类 采用GA XXX.2中的“重点人员处置措施细类代码”")
	private String czcsxl;
	@FieldDesc("吸毒查获尿检信息 查获吸毒人员时填写，负责为空；采用“毒品种类代码/尿检结果代码”表示，其中毒品种类代码采用《GA 332.1禁毒信息管理代码 第 1 部分：毒品种类代码》，尿检结果代码采用GAXXX.2中的重点人员吸毒尿检结果代码；可多值，以半角逗号间隔，最多8个")
	private String xdchnjxx;
	@FieldDesc("现场查获物品信息 现场查获重点人员时填写，否则为空；当前仅填写吸毒人员查获毒品信息，采用{DP:查获毒品信息“｝”格式表示；这里的查获毒品信息以“毒品种类代码/缴获数量”格式表示，这里的毒品种类代码采用《GA 332.1禁毒信息管理代码 第 1 部分：毒品种类代码》，缴获数量为字符型字符串，总长度为10，数值保留3位小数，不足10位时前面补空格；查获毒品信息可多值，以半角逗号间隔，最多7个")
	private String xcchwpxx;
	@FieldDesc("立线侦查工作评估 立线侦查结束后填写，否则为空；采用GAXXX.2中的“重点人员常控预警工作评估代码”")
	private String lxzcgzpg;
	@FieldDesc("立线侦查工作评估依据， 立线侦查结束后填写，否则为空；")
	private String lxzcgzpgyj;
	@FieldDesc("目标从事职业类型  当立线侦查工作评估项的值为“60-未发现犯罪嫌疑”、“70-排除在本地作案嫌疑”时填写，否则为空；采用GAXXX.2中的“重点人员从事职业类别代码”")
