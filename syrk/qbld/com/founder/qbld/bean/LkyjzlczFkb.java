...
/**
 * ****************************************************************************
 * @Package:      [com.founder.qbld.bean.LkyjzlczFkb.java]  
 * @ClassName:    [LkyjzlczFkb]   
 * @Description:  [临控预警指令表]   
 * @Author:       [yu_sun@founder.com.cn]  
 * @CreateDate:   [2015-6-8 上午9:41:22]   
 * @UpdateUser:   [founder(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-6-8 上午9:41:22，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0]
 */
@DBInfoAnnotation(tableName = "QBLD_LK_ZLCZFKB", pk = "lkzlbh")
public class LkyjzlczFkb extends BaseEntity implements Serializable {
