...
/**
 * ****************************************************************************
 * @Package:      [com.founder.qbld.bean.ZdryZdxsfzqk.java]  
 * @ClassName:    [ZdryZdxsfzqk]   
 * @Description:  [重大刑事犯罪前科表]   
 * @Author:       [yu_sun@founder.com.cn]  
 * @CreateDate:   [2015-5-29 下午5:52:58]   
 * @UpdateUser:   [founder(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2015-5-29 下午5:52:58，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0]
 */
@DBInfoAnnotation(tableName = "QBLD_SK_ZDRY_ZDXSFZQKXX", pk = "id")
public class ZdryZdxsfzqk extends BaseEntity implements Serializable {
